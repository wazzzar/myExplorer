...
function onCheckBoxIncludePathClick() {
    var n = document.getElementById("CheckBoxIncludePath");
    enableElement("TextBoxPath", !n.disabled && n.checked, null, !0)
}

function onCheckBoxExpiresClick() {
    enableElement("TextBoxExpirationDays", document.getElementById("CheckBoxExpires").checked, null, !0)
}

function onCheckBoxLimitHitsClick() {
    enableElement("TextBoxHitLimit", document.getElementById("CheckBoxLimitHits").checked, null, !0)
}

function onCheckBoxPasswordProtectClick() {
    var n = document.getElementById("CheckBoxPasswordProtect").checked;
    document.getElementById("LabelPassword").className = n ? "" : "disabled";
    enableElement("Password", n, "", n);
    document.getElementById("LabelPasswordConfirm").className = n ? "" : "disabled";
    enableElement("PasswordConfirm", n, "", n);
    RequiredFieldValidator2.enabled = n
}

function selectLabelPublicLink() {
    StolenTech.JavaScript.Util.SelectRange("LabelPublicLink")
}

function onButtonTestClick() {
    var n = document.getElementById("LabelPublicLink").firstChild.nodeValue;
    window.open(n, "_blank")
}

function onButtonEmailClick() {
    var n = document.getElementById("LabelPublicLink").firstChild.nodeValue;
    window.top.location.href = "mailto:?Body=" + encodeURIComponent(n)
}

function onSubmit() {
    document.getElementById("FieldPath").value = document.getElementById("TextBoxPath").value;
    document.getElementById("FieldExpirationDays").value = document.getElementById("TextBoxExpirationDays").value;
    document.getElementById("FieldHitLimit").value = document.getElementById("TextBoxHitLimit").value
}

function onPasswordFocus() {
    var n = document.getElementById("PasswordTemplate").value;
    (document.getElementById("Password").value == n || document.getElementById("PasswordConfirm").value == n) && (document.getElementById("Password").value = "", document.getElementById("PasswordConfirm").value = "")
}
...
StolenTech.JavaScript.Util.OnDomReady(function () {
    var t = document.getElementById("OnLoadCommand").value, n;
    switch (t) {
        case"Close":
            elementDialog.close();
            return
    }
    onCheckBoxIncludePathClick();
    onCheckBoxExpiresClick();
    onCheckBoxLimitHitsClick();
    onCheckBoxPasswordProtectClick();
    StolenTech.JavaScript.Util.AddEvent(document.getElementById("TextBoxExpirationDays"), "click", StolenTech.JavaScript.Util.CancelEvent);
    StolenTech.JavaScript.Util.AddEvent(document.getElementById("TextBoxHitLimit"), "click", StolenTech.JavaScript.Util.CancelEvent);
    StolenTech.JavaScript.Util.AddEvent(document.getElementById("LabelPublicLink"), "click", selectLabelPublicLink);
    StolenTech.JavaScript.Util.AddEvent(document.getElementById("LabelPublicLink"), "contextmenu", selectLabelPublicLink);
    StolenTech.JavaScript.Util.AddEvent(document.getElementById("Password"), "focus", onPasswordFocus);
    StolenTech.JavaScript.Util.AddEvent(document.getElementById("PasswordConfirm"), "focus", onPasswordFocus);
    n = document.getElementById("LabelPublicLink").parentNode;
    n.parentNode.clientHeight < n.offsetHeight && (n.parentNode.style.height = n.parentNode.offsetHeight - n.parentNode.clientHeight + n.offsetHeight + "px");
    t == "Message" && showClientMessage()
});