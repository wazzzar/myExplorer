(function (n, t) {
    ...
    function b(n) {
        for (var t, i = n._util, r = 0; r < i.count; r++) t = i.elements[r], !a(t, n.options.successClass) && rt(t, n.options) && n.load(t);
        i.count === 0 && n.destroy()
    }

    function rt(t, i) {
        var f = t.getBoundingClientRect(), u, r;
        if (i.container && y && (u = t.closest(i.containerClass), u)) {
            if (r = u.getBoundingClientRect(), c(r, n)) {
                var e = r.top - i.offset, o = r.right + i.offset, s = r.bottom + i.offset, h = r.left - i.offset, l = {
                    top: e > n.top ? e : n.top,
    ...
    function k(n, o, c) {
        var w;
        if (!a(n, c.successClass) && (o || c.loadInvisible || n.offsetWidth > 0 && n.offsetHeight > 0)) if (w = e(n, h) || e(n, c.src), w) {
            if (w === "{dynamic}") {
                ut(n, c);
                return
            }
            var tt = w.split(c.separator), b = tt[v && tt.length > 1 ? 1 : 0], rt = e(n, c.srcset), et = u(n, "img"),
                k = n.parentNode, ot = k && u(k, "picture");
            if (et || n.src === undefined) {
                var y = new Image, g = function () {
    ...
    function ut(n, t) {
        var r = u(n, "img"), i = n.parentNode, e = i && u(i, "picture"), o = function () {
    ...
    function i(n, t) {
        var r, i;
        if (n && t) for (r = n.length, i = 0; i < r && t(n[i], i) !== !1; i++) ;
    }
...
Ext.define("StolenTech.UI.BusyManager", {
...
Ext.define("StolenTech.UI.MessageBox", {
    ...
    reconfigure: function (n) {
        ...
        n.htmlEncodeTitle !== !1 && (n.title = Ext.htmlEncode(n.title));
        n.htmlEncodeMessage !== !1 && (n.message = Ext.htmlEncode(n.message));
        this.callParent(arguments);
    ...
    showError: function (n) {
        Ext.isString(n) && (n = {message: n});
        var t = {title: "", icon: this.ERROR, buttons: this.OK};
        return this.show(Ext.applyIf(n, t))
    },
    showWarning: function (n) {
        Ext.isString(n) && (n = {message: n});
        var t = {title: "", icon: this.WARNING, buttons: this.OK};
        return this.show(Ext.applyIf(n, t))
    },
    showInfo: function (n) {
        Ext.isString(n) && (n = {message: n});
        var t = {title: "", icon: this.INFO, buttons: this.OK};
        return this.show(Ext.applyIf(n, t))
    },
    showPrompt: function (n) {
        Ext.isString(n) && (n = {message: n});
        var t = {title: "", buttons: this.OKCANCEL, minWidth: this.minPromptWidth, prompt: !0};
        return this.show(Ext.applyIf(n, t))
    },
    showConfirm: function (n) {
        Ext.isString(n) && (n = {message: n});
        var t = {title: "", icon: this.QUESTION, buttons: this.YESNO};
        return this.show(Ext.applyIf(n, t))
    },
    showConflict: function (n) {
        Ext.isString(n) && (n = {message: n});
        var t = {title: "", conflictConfig: {remainingConflicts: undefined}};
        return this.show(Ext.applyIf(n, t))
    },
    ...
    addDetailsPanel: function (n) {
        var r = n.detailsConfig, i, u, t, f, e;
        r && (i = r.data, u = r.type, i) && (Ext.applyIf(n, {resizable: !0}), t = new Ext.panel.Panel({
            title: "Details",
            collapsible: !0,
            collapsed: !0,
            titleCollapse: !0,
        ...
        }), u === "html" ? t.add(new StolenTech.UI.IFrame({srcDoc: i})) : u === "json" ? (f = function (n, t) {
            var i, r, u;
        ...
        }, e = {expanded: !0}, f(i, e), t.add(new Ext.tree.Panel({
            rootVisible: !1,
            useArrows: !0,
            columnLines: !0,
            rowLines: !0,
            ...
            autoSizeColumns: function () {
                Ext.each(this.columns, function (n) {
            ...
            listeners: {
                viewready: function (n) {
                    n.autoSizeColumns()
                }, afteritemexpand: function (n) {
                    n.getOwnerTree().autoSizeColumns()
                }, afteritemcollapse: function (n) {
                    n.getOwnerTree().autoSizeColumns()
                }, render: function (n) {
                    ...
                    n.add(new Ext.tip.ToolTip({
                        ...
                        dismissDelay: 0,
                        showDelay: 800,
                        constrainTo: Ext.getBody().getRegion().adjust(5, -5, -5, 5),
                        shadow: "drop",
                        cls: "x-pre",
                        maxWidth: null,
                        listeners: {
                            beforeshow: function (n) {
                                var i = t.getRecord(n.triggerElement), r, u, f, e;
                                if (!i || (r = t.getHeaderByCell(n.triggerElement).dataIndex, u = t.getColumnManager().getHeaderByDataIndex(r), !u)) return !1;
                                f = u.initialConfig.renderer;
                                e = f ? f(i.get(r), null, i) : i.get(r);
                                n.update(e)
                            }
                        }
                    }))
        ...
        }))) : t.add(new Ext.form.field.TextArea({readOnly: !0, value: i})), this.add(t), this.destroyList.push(t))
    },
    addPromptValidator: function (n) {
        var r = n.promptConfig;
        if (r) {
            var u = r.validatorFn, f = r.selectionLength, t = this.textField, i = this.msgButtons.ok;
    ...
    addCountDown: function (n) {
        ...
        if (this.countDownTask && (this.countDownTask.stop(!0), delete this.countDownTask), t) {
            var i = this, r = this.msgButtons[t.buttonId], u = this.buttonText[t.buttonId];
            this.countDownTask = Ext.util.TaskManager.newTask({
                run: function (n) {
                    var i = t.seconds - n + 1;
                    i === 0 ? r.click() : r.setText(u + " (" + i + ")")
                }, interval: 1e3, fireOnStart: !0, repeat: t.seconds + 1
            });
    ...
    addItemsPanel: function (n) {
        var t = n.itemsConfig;
        if (t) {
            Ext.applyIf(n, {resizable: !0});
            var i = new Ext.data.Store({model: t.model}), r = new StolenTech.UI.MultiView(Ext.apply({
                store: i,
                multipleSelection: !1,
                flex: 1,
                minWidth: 500,
                height: 150,
                width: 500
            }, t.multiViewConfig)), u = new StolenTech.UI.MultiViewStatusBar({border: 0, multiView: r});
            i.add(t.records);
            this.add(r);
            this.add(u);
        ...
        if (t) {
            ...
            var f = new Ext.XTemplate(['<span class="x-conflict-action-icon"><\/span>', '<div class="x-conflict-action">', '<span class="x-conflict-action-title">{actionTitle}<\/span><br/>', '<span class="x-conflict-action-description">{actionDescription}<\/span><br/>', '<tpl if="showItemInfo">', '<div class="x-item x-layout-tiles">', '<span class="x-item-icon {iconCls}">', "<\/span>", '<div class="multiline-vertical-center">', "<div>", "<b>{itemName}<\/b>", '<tpl for="itemProperties">', '<br/><span class="x-item-value">{name}: {value}<\/span>', "<\/tpl>", "<\/div>", "<\/div>", "<\/div>", "<tpl else>", "<b>{itemName}<\/b>", "<\/tpl>", "<\/div>"]),
                o = {
                    ...
                    itemName: Ext.htmlEncode(t.itemCopyName)
                };
            for (e = 0; e < t.columns.length; e++) r = t.columns[e], u = StolenTech.UI.MultiView.createColumnRendererFn(r), r.isPrimary ? (o.itemName = u(t.newRecord), s.itemName = u(t.existingRecord)) : (i = u(t.newRecord), i && o.itemProperties.push({
                name: r.text,
                value: i
            }), i = u(t.existingRecord), i && s.itemProperties.push({name: r.text, value: i}));
            h = new Ext.toolbar.Toolbar({
                layout: {type: "vbox", align: "stretch"},
                border: 0,
                defaults: {margin: "0 10 8 10", textAlign: "left"},
                ...
                items: [{
                    ...
                    scope: this,
                    itemId: "replace"
                }, {text: f.apply(s), handler: this.btnCallback, scope: this, itemId: "skip"}, {
                    text: f.apply(a),
                    handler: this.btnCallback,
                    scope: this,
                    itemId: "keepboth"
...
Ext.define("StolenTech.UI.Ribbon", {
    extend: "Ext.tab.Panel", floatCls: Ext.baseCSSPrefix + "border-region-slide-in", initComponent: function () {
        Ext.apply(this, {
            collapsible: !0,
            hideCollapseTool: !0,
            collapseMode: "header",
        ...
        this.tabBar.un({click: this.tabBar.onClick, element: "el", scope: this.tabBar});
        this.tabBar.on({mousedown: this.tabBar.onClick, element: "el", scope: this.tabBar})
    }, updateHeader: function () {
        this.tabBar.isHeader = !0;
        this.header = this.tabBar;
        this.callParent(arguments)
    }, initTabConfig: function (n) {
        if (n.xtype = n.xtype || "toolbar", n.border = !1, n.layout = {align: "stretch"}, n.cls = "x-unselectable", n.tabConfig = {focusable: !1}, n.overflowHandler = "scroller", Ext.isArray(n.items)) for (var t = 0; t < n.items.length; t++) this.initGroupConfig(n.items[t])
    }, initGroupConfig: function (n) {
        var i, t, r;
        if (n.xtype = n.xtype || "buttongroup", n.layout = n.layout || {type: "hbox"}, n.headerPosition = n.headerPosition || "bottom", n.frame = !1, Ext.isArray(n.items)) for (i = 0; i < n.items.length; i++) if (t = n.items[i], t.xtype == "container") for (t.listeners = {
            beforeadd: function (n, t) {
                t.isButton && (t.ui = t.ui + "-toolbar")
            }
        }, r = 0; r < t.items.length; r++) this.initItemConfig(t.items[r]); else this.initItemConfig(t)
        ...
        this.updateLayout();
        this.body.show();
        Ext.getDoc().on({mousedown: this.handleMouseDown, scope: this, capture: !0})
    }, makeUnfloated: function () {
        this.removeCls(this.floatCls);
        this.floatedFromCollapse = null;
        this.collapse();
        Ext.getDoc().un({mousedown: this.handleMouseDown, scope: this, capture: !0})
...
Ext.define("StolenTech.UI.Breadcrumb", {
    extend: "Ext.toolbar.Breadcrumb", showIcons: !1, initComponent: function () {
        this.callParent(arguments);
        ...
        var i = this, o = i._buttons, y = [], h = i.items.getCount(), w = i._needsSync, b = i.getDisplayField(), c, l,
            f, a, v, r, e, t, p, s, u;
        if (Ext.suspendLayouts(), n) {
            for (r = n, s = n.get("depth"), v = s + 1, u = s; r;) {
                if (p = r.getId(), t = o[u], !w && t && t._breadcrumbNodeId === p) break;
                e = r.get(b);
                e = Ext.htmlEncode(e);
                t ? t.setText(e) : t = o[u] = Ext.create({
                    ...
                    showEmptyMenu: !0,
                    menu: {
                        listeners: {click: "_onMenuClick", beforeshow: "_onMenuBeforeShow", scope: this},
                        alignOffset: [-34, 0],
                ...
                e.length == 0 ? (t.addCls("x-no-text"), t.setText("&#160;")) : t.removeCls("x-no-text");
                c = this.getShowIcons();
            ...
            if (this.showIcons === !1 && (f = n.get("iconCls"), t = o[0], f && t.setIconCls(f)), i.removeCls("x-breadcrumb-empty"), v > h) y = o.slice(h, s + 1), i.add(y); else for (u = h - 1; u >= v; u--) i.remove(i.items.items[u], !1)
        } else i.removeAll(!1), i.addCls("x-breadcrumb-empty");
        Ext.resumeLayouts(!0);
        i.fireEvent("selectionchange", i, n);
        i._needsSync = !1
    }, busyActive: !1, showBusy: function () {
        if (!this.busyActive) {
            this.busyActive = !0;
        ...
        _onMenuClick: function (n, t) {
            ...
            var t = this, l = t.getStore().getNodeById(n.ownerCmp._breadcrumbNodeId), y = t.getDisplayField(),
                a = t.getShowMenuIcons(), o, i, s, h, u, c, f, v, r, e;
            if (l.hasChildNodes()) {
                for (o = l.childNodes, h = [], u = 0, v = o.length; u < v; u++) i = o[u], e = i.get(y), e = Ext.htmlEncode(e), r = {
                    text: e,
                    _breadcrumbNodeId: i.getId()
                }, a !== !1 && (s = i.get("glyph"), c = i.get("icon"), f = i.get("iconCls"), s ? (r.glyph = s, r.iconCls = f) : c ? r.icon = c : f ? r.iconCls = f : a && (r.iconCls = (i.isLeaf() ? t._leafIconCls : t._folderIconCls) + "-" + t.ui)), t.selection && (i == t.selection || i.contains(t.selection)) && (r.cls = "x-menu-item-bold"), h.push(r);
                n.removeAll();
                n.add(h)
            } else return !1
        }
...
Ext.define("StolenTech.UI.SearchField", {
    extend: "Ext.form.field.Text",
    triggers: {
        search: {cls: "x-form-trigger-search"},
        clear: {
            cls: "x-form-trigger-clear", hidden: !0, handler: function (n) {
                n.reset()
            }
        }
    },
    initComponent: function () {
        this.callParent();
        this.on("change", this.updateTriggerUI, this, {priority: 1});
...
Ext.define("StolenTech.UI.DragSelector", {
    ...
    fillAllRegions: function () {
        var n = this, t = n.objectsSelected = [];
    ...
    fillRegions: function () {
        var t = this.rs = [], n = this.view;
        Ext.Object.each(n.all.elements, function (i, r) {
            t.push({region: Ext.util.Region.getRegion(r), record: n.getRecord(r)})
        })
    },
    onBeforeStart: function (n) {
        if (n.originalButton === 1) return !1;
        var t = n.getTarget(null, null, !0), i, r;
    ...
    onStart: function () {
        ...
        n.createProxy().show();
        n.dragging = !0;
        n.view.on("beforecontainerclick", n.cancelEvent, n, {single: !0})
    },
    ...
    createProxy: function () {
        ...
        return this.proxy = this.view.getEl().createChild({tag: "div", cls: "x-view-selector"}), this.proxy
    },
    onDrag: function (n, t) {
        var i = this, f = i.selModel, k = i.proxy, v = i.bodyRegion, y = i.dragRegion, u = i.tracker.startXY,
            r = i.tracker.getXY(), p = Math.min(u[0], r[0]), c = Math.min(u[1], r[1]) - i.scrollTop,
            w = Math.abs(u[0] - r[0]), l = Math.abs(u[1] - r[1]) + i.scrollTop, e, a;
        for (r[0] < u[0] && !t && (r[0] += 2), i.scrollTop >= 0 ? (u[1] - i.scrollTop > r[1] && (c = r[1], l = Math.abs(u[1] - r[1]) - i.scrollTop), v.top = v.y -= i.scrollTop) : (u[1] - i.scrollTop > r[1] && (c = r[1], l = Math.abs(u[1] - i.scrollTop - r[1])), v.bottom -= i.scrollTop), w == 0 && (w = 1), l == 0 && (l = 1), Ext.apply(y, {
            ...
            var b = i.rs[a], s = y.intersect(b.region), o = b.record, h = f.isSelected(o), d = i.objectsSelected[a];
...
Ext.define("StolenTech.UI.StatusBar", {
    ...
    initComponent: function () {
        ...
        this.separatorItem = new Ext.toolbar.Separator({hidden: !0, style: {marginLeft: "4px", marginRight: "4px"}});
    ...
    setStatus: function (n) {
        var i = this;
        if (n = n || {}, Ext.suspendLayouts(), Ext.isString(n) && (n = {text: n}), n.text !== undefined && i.setText(n.text), n.iconCls !== undefined && i.setIcon(n.iconCls), n.clear) {
            var t = n.clear, r = i.autoClear, u = {useDefaults: !0, anim: !0};
    ...
    clearStatus: function (n) {
        ...
        return (n = n || {}, t = this, i = t.statusItem, n.threadId && n.threadId !== t.activeThreadId) ? t : (r = n.useDefaults ? t.defaultText : t.emptyText, u = n.useDefaults ? t.defaultIconCls ? t.defaultIconCls : "" : "", n.anim ? i.el.puff({
            ...
            callback: function () {
                i.el.show();
                t.setStatus({text: r, iconCls: u})
            }
        }) : t.setStatus({text: r, iconCls: u}), t)
    },
    setText: function (n) {
        var t = this;
...
Ext.define("StolenTech.UI.MultiView", {
    ...
    viewLayoutTypes: [{
        ...
        component: "dataview",
        iconPadding: 12
    }, {name: "largeicons", iconSize: 96, component: "dataview", iconPadding: 6}, {
        name: "mediumicons",
        iconSize: 48,
        component: "dataview",
        iconPadding: 3
    }, {name: "smallicons", iconSize: 16, component: "dataview", iconPadding: 0}, {
        name: "details",
        iconSize: 16,
        component: "gridpanel",
        iconPadding: 0
    }, {name: "tiles", iconSize: 48, component: "dataview", iconPadding: 3}],
    activeViewComponent: null,
    lazyImageLoader: null,
    toolTip: null,
    deferEmptyText: !0,
    renderPrimaryColumnFn: null,
    renderFirstTileColumnFn: function () {
        return ""
    },
    renderSecondTileColumnFn: function () {
        return ""
    },
    renderToolTipColumnFns: null,
    statics: {
        createColumnRendererFn: function (n, t) {
            var i = t ? n.tileFormatterFn || n.formatterFn : n.formatterFn, r = n.dataIndex, u = n.htmlEncode;
            return function (n) {
                var t = n.data[r];
                return i && (t = i(t, n)), u && (t = Ext.htmlEncode(t)), t
            }
        }
    },
    initComponent: function () {
        Ext.apply(this, {layout: {type: "fit"}, cls: "x-multiview"});
        this.callParent();
        this.initColumnsConfig();
        this.createThrottledFunctions();
        this.mon(this.store, {scope: this, datachanged: this.onViewStoreDataChanged});
        this.setViewLayout(this.initialConfig.viewLayout, !0)
    },
    createThrottledFunctions: function () {
        this.onSelectionChangeThrottled = StolenTech.Util.Function.throttle(this.onSelectionChange, 200, this);
        this.onViewRenderChangeThrottled = StolenTech.Util.Function.throttle(this.onViewRenderChange, 25, this, {leading: !1})
    },
    onDestroy: function () {
        this.callParent();
    ...
    initColumnsConfig: function () {
        var t, i, n;
        if (this.columns) {
            for (t = this.statics(), i = 0; i < this.columns.length; i++) n = this.columns[i], Ext.apply(n, {
                renderer: this.createGridColumnRendererFn(n),
                scope: this
            }), n.isPrimary ? this.renderPrimaryColumnFn = t.createColumnRendererFn(n) : (n.tdCls = "x-item-value", n.isTileFirstValue ? this.renderFirstTileColumnFn = t.createColumnRendererFn(n, !0) : n.isTileSecondValue && (this.renderSecondTileColumnFn = t.createColumnRendererFn(n, !0)), n.isToolTipValue && (this.renderToolTipColumnFns || (this.renderToolTipColumnFns = []), this.renderToolTipColumnFns.push({
                columnText: n.text,
                renderer: t.createColumnRendererFn(n, !0)
            })));
            this.renderPrimaryColumnFn == null && (this.renderPrimaryColumnFn = t.createColumnRendererFn(this.columns[0]))
        }
    },
    createGridColumnRendererFn: function (n) {
        var t = this.statics().createColumnRendererFn(n),
            i = n.isPrimary ? this.gridIconColumnRenderer : this.gridColumnRenderer;
        return function (n, r, u) {
            return n = t(u), i.apply(this, [n, r, u])
        }
    },
    setViewLayout: function (n, t, i) {
        ...
        if (!this.isConfiguring && (i || !this.viewLayoutLock)) {
            ...
            (u = this.viewLayout, i || r !== u) && (this.viewLayout = r, !i && u && u.component === r.component ? this.activeView.refresh() : (Ext.suspendLayouts(), this.activeViewComponent && (f = this.activeViewComponent.getSelectionModel().getSelection(), this.remove(this.activeViewComponent, !0)), this.activeViewComponent = r.component == "gridpanel" ? this.createGridPanel() : this.createDataView(), this.activeView = this.activeViewComponent.isDataView ? this.activeViewComponent : this.activeViewComponent.getView(), f && this.activeViewComponent.getSelectionModel().select(f, !1, !0), this.add(this.activeViewComponent), Ext.resumeLayouts(!0), this.deferEmptyText = !1), t || this.fireEvent("layoutchange", this, r, u))
        }
    },
        ...
        return new Ext.grid.Panel({
            ...
            viewConfig: {
                ...
                listeners: {
                    ...
                    itemlongpress: this.onItemContextMenu,
                ...
                plugins: {
                    ...
                    gtviewnativedrop: {enableNativeDrop: this.enableNativeDrop}
                }
            },
            selModel: {
                ...
                listeners: {selectionchange: this.onSelectionChangeThrottled}
            }
        })
    },
    gridIconColumnRenderer: function (n, t, i) {
    ...
    createDataView: function () {
        ...
        return new Ext.view.View({
            ...
            autoScroll: !0,
            trackOver: !0,
            cls: "x-dataview x-unselectable x-multiview-ct",
            ...
            prepareData: function (t, i, r) {
                var u = {
                    ...
                    itemName: n.renderPrimaryColumnFn(r)
                }, e, f;
                return n.viewLayout.iconSize >= 32 && (e = n.viewLayout.iconSize - n.viewLayout.iconPadding, u.itemThumbnailSrc = n.getItemThumbnailSrc.fn.apply(n.getItemThumbnailSrc.scope, [r, e]), u.itemThumbnailSrc = Ext.htmlEncode(u.itemThumbnailSrc)), f = n.getItemIconCls.fn.apply(n.getItemIconCls.scope, [r, n.viewLayout.iconSize]), u.itemThumbnailSrc ? u.fallbackIconCls = f : u.iconCls = f, n.viewLayout.name == "tiles" && (u.itemFirstValue = n.renderFirstTileColumnFn(r), u.itemSecondValue = n.renderSecondTileColumnFn(r)), u.checkbox = n.checkboxSelection, u
            },
            listeners: {
                scope: this,
                afterrender: this.onViewAfterRender,
        ...
        this.toolTip ? (this.toolTip.view = n, this.toolTip.setTarget(n.el), this.toolTip.delegate = n.itemSelector) : this.toolTip = new Ext.tip.ToolTip({
            ...
            listeners: {
                render: function (n) {
                    ...
                    fn: function (n) {
                        var t = n.view.getRecord(n.triggerElement), i;
                        if (!t) return !1;
                        i = this.renderPrimaryColumnFn(t);
                        Ext.Array.each(this.renderToolTipColumnFns, function (n) {
                            var r = n.renderer(t);
                            r && (i += "<br/>" + n.columnText + ": " + r)
                        });
                        n.update(i)
                    }, scope: this
                }
    ...
    onItemContextMenu: function (n, t, i, r, u) {
        var f = n.getSelectionModel(), e = u.getTarget(null, null, !0);
    ...
    initLazyImageLoader: function (n) {
        ...
        if (this.lazyImageLoader) this.lazyImageLoader.revalidate(); else {
            var t = this;
            this.lazyImageLoader = new Blazy({
                ...
                dynamicLoad: function (n, i, r) {
                    var u = t.activeView.getNode(n), f = t.activeView.getRecord(u), e;
                    if (!u || !f) {
                        r();
                        return
                    }
                ...
                containerBindEvents: function (i, r) {
                    if (r) {
                        n.on("scroll", i, null, {onFrame: !0});
                        t.on("resize", i, null, {onFrame: !0})
    ...
    unlockViewLayout: function (n) {
        var i, t;
        this.viewLayoutLock && (i = this.viewLayoutLock, delete this.viewLayoutLock, n && this.revertViewLayout(), t = [], Ext.Array.each(this.viewLayoutTypes, function (n) {
            n.name !== i && t.push(n.name)
        }), this.toggleViewLayoutState(t, !0))
    },
    revertViewLayout: function () {
        this.viewLayoutBeforeLock && (this.setViewLayout(this.viewLayoutBeforeLock), delete this.viewLayoutBeforeLock)
    },
    refresh: function () {
        this.activeView && this.activeView.refresh()
    },
    toggleViewLayoutState: function (n, t) {
        var i = Ext.Array.map(n, function (n) {
            return {name: n.toLowerCase(), enabled: t}
        });
        this.fireEvent("layoutstatechange", this.activeView, i)
    }
});
Ext.define("StolenTech.UI.DataViewCheckboxModel", {
...
Ext.define("StolenTech.UI.MultiViewStatusBar", {
    extend: "StolenTech.UI.StatusBar",
    mixins: ["StolenTech.UI.ActionHandler"],
    statics: {sprite: new StolenTech.UI.Sprite("explorerviewicons")},
    config: {
        multiView: null, getDataStatusText: {
            fn: function () {
                return ""
            }, scope: null
    ...
    initComponent: function () {
        ...
        Ext.apply(this, {defaults: {focusable: !1}, items: t});
        this.mon(this.multiView.getStore(), {scope: this, datachanged: this.onViewStoreDataChanged});
        ...
        this.callParent();
        this.getControlAction("ToggleLayout" + this.multiView.viewLayout.name).each(function (n) {
            n.toggleUIOnly(!0)
        })
    },
    ...
    onViewStoreDataChanged: function (n) {
        var t = n.getCount(),
            i = t === 1 ? StolenTech.Util.Language.getEntry("Label.ItemCount", t) : StolenTech.Util.Language.getEntry("Label.ItemsCount", t),
            r = this.getDataStatusText.fn.apply(this.getDataStatusText.scope, [n.getData().items]);
        r.length > 0 && (i += "&#160;&#160;" + r);
        this.setPrimaryText(i)
    },
    onViewSelectionChange: function (n, t) {
        var i = t.length, r, u;
        i === 0 ? this.setSecondaryText(null) : (r = i === 1 ? StolenTech.Util.Language.getEntry("Label.SelectedItemCount", i) : StolenTech.Util.Language.getEntry("Label.SelectedItemsCount", i), u = this.getSelectionStatusText.fn.apply(this.getSelectionStatusText.scope, [t]), u.length > 0 && (r += "&#160;&#160;" + u), this.setSecondaryText(r))
    },
    onViewLayoutChange: function (n, t, i) {
        this.getControlAction("ToggleLayout" + t.name).each(function (n) {
            n.toggleUIOnly(!0)
        });
        i && this.getControlAction("ToggleLayout" + i.name).each(function (n) {
            n.toggleUIOnly(!1)
        })
    },
...
Ext.define("StolenTech.UI.ReferrerIframe", {
    el: null, window: null, constructor: function (n) {
        this.parentEl = n
        ...
        this.el = Ext.get(Ext.DomHelper.createDom({tag: "iframe", id: i, name: i, style: "display: none", src: n}));
...
Ext.define("StolenTech.UI.DragDropProxy", {
    ...
    reset: function (n) {
        var t = this, i = "x-dd-proxy " + Ext.baseCSSPrefix + "dd-drag-proxy ";
...
Ext.define("StolenTech.UI.ViewDragZone", {
    extend: "Ext.view.DragZone", selectOnDrag: !0, constructor: function (n) {
        var t, i = n.view, r = i.ownerCt;
        t = r ? r.getTargetEl().dom : i.el.dom.parentNode;
        this.proxy = new StolenTech.UI.DragDropProxy({id: t.id + "-drag-proxy", animRepair: this.animRepair});
        this.callParent(arguments);
        this.ddel.className = "x-dd-item " + this.ddel.className
    }, onInitDrag: function (n, t) {
        var i = this, r = i.dragData, e = r.view, u = e.getSelectionModel(), f = e.getRecord(r.item), o;
        this.selectOnDrag && !u.isSelected(f) && (u.selectWithEvent(f, i.DDMInstance.mousedownEvent), r.records = u.getSelection());
        r.records.length > 1 ? Ext.fly(i.ddel).setHtml('<div class="x-dd-item-number"><div>' + r.records.length + "<\/div><\/div>") : (o = this.getItemIconCls.fn.apply(this.getItemIconCls.scope, [f, 96]), Ext.fly(i.ddel).setHtml('<div class="x-dd-item-icon ' + o + '"><\/div>'));
...
Ext.define("StolenTech.UI.TreeDragZone", {
    extend: "StolenTech.UI.ViewDragZone",
    selectOnDrag: !1,
    isPreventDrag: function (n, t) {
        return t.get("allowDrag") === !1 || !!n.getTarget(this.view.expanderSelector)
    },
    getDragData: function (n) {
        var t = this.view, i = n.getTarget(t.getItemSelector());
        if (i) return {
            ...
            fromPosition: Ext.fly(i).getXY()
        }
    }
});
Ext.define("StolenTech.UI.ViewDropZone", {
    extend: "Ext.dd.DropZone", constructor: function (n) {
        var t = this;
        Ext.apply(t, n);
...
Ext.define("StolenTech.UI.TreeDropZone", {
    extend: "StolenTech.UI.ViewDropZone",
    expandDelay: 500,
...
Ext.define("StolenTech.UI.ViewDragDropPlugin", {
    extend: "Ext.grid.plugin.DragDrop",
    alias: "plugin.gtviewdragdrop",
    containerScroll: !0,
    onViewRender: function (n) {
        var t = this, i;
        t.enableDrag && (t.containerScroll && (i = n.getEl()), t.dragZone = new StolenTech.UI.ViewDragZone(Ext.apply({
            view: n,
        ...
        t.enableDrop && (t.dropZone = new StolenTech.UI.ViewDropZone(Ext.apply({
            view: n,
            ddGroup: t.dropGroup || t.ddGroup
        }, t.dropZone)))
    }
});
Ext.define('"StolenTech.UI.TreeDragDropPlugin', {
    extend: "Ext.tree.plugin.TreeViewDragDrop",
    alias: "plugin.gttreedragdrop",
    containerScroll: {vthresh: Ext.dd.ScrollManager.vthresh, hthresh: -1},
    onViewRender: function (n) {
        var t = this, i;
        t.enableDrag && (t.containerScroll && (i = n.getEl()), t.dragZone = new StolenTech.UI.TreeDragZone(Ext.apply({
            view: n,
            ddGroup: t.dragGroup || t.ddGroup,
            dragText: t.dragText,
        ...
        t.enableDrop && (t.dropZone = new StolenTech.UI.TreeDropZone(Ext.apply({
            view: n,
            ddGroup: t.dropGroup || t.ddGroup,
...
Ext.override(Ext.dd.DragDropManager, {
    addListeners: function () {
        this.callParent(arguments);
        Ext.getDoc().on({keydown: {fn: this.onKeyDown, scope: this}, keyup: {fn: this.onKeyUp, scope: this}})
...
Ext.define("StolenTech.UI.ViewNativeDropPlugin", {
    extend: "Ext.plugin.Abstract",
    alias: "plugin.gtviewnativedrop",
    enableNativeDrop: !0,
    init: function (n) {
        this.view = n;
        this.view.on("render", this.onRender, this, {single: !0})
    },
    onRender: function (n) {
        this.enableNativeDrop && (this.dragTarget = new StolenTech.UI.ViewDropTarget({
            element: n.el,
            listeners: {
                scope: this,
...
Ext.define("StolenTech.UI.ViewDropTarget", {
    extend: "Ext.drag.Target", animRepair: !0, constructor: function () {
        this.callParent(arguments);
        this.containerTarget = this.getElement().dom;
        this.proxy = new StolenTech.UI.DragDropProxy({
        ...
        handleNativeDragEnter: function (n) {
            var i = this.getTargetFromEvent(n), r = Ext.Array.findBy(this.enteredItems, function (n) {
                return n.item === i
            }), f, t, u;
            if (r || (r = {item: i, count: 0}, this.enteredItems.push(r)), r.count++, !(r.count > 1)) {
            ...
            var i = this.getTargetFromEvent(n), u = Ext.Array.findBy(this.enteredItems, function (n) {
                return n.item === i
            }), f, t, r;
        ...
        var i = n.browserEvent.dataTransfer, t;
    ...
    }, expandDelay: 500, expandNode: function (n) {
        var t = this.view;
        this.expandProcId = !1;
        n.isLeaf() || n.isExpanded() || (t.expand(n), this.expandProcId = !1)
    }, queueExpand: function (n) {
...
Ext.define("StolenTech.UI.ExplorerView", {
    extend: "Ext.panel.Panel",
    mixins: ["StolenTech.UI.ServerHandler", "StolenTech.UI.ActionHandler", "StolenTech.UI.EventHandler"],
    statics: {sprite: new StolenTech.UI.Sprite("explorerviewicons")},
    config: {
        showRibbon: !0,
        collapseRibbon: !1,
    ...
    initComponent: function () {
        ...
        Ext.apply(this, {defaults: {border: !1}, layout: {type: "border"}, items: n});
        this.busyManager = new StolenTech.UI.BusyManager({
            listeners: {
                showBusy: {fn: this.onShowBusy, scope: this},
                hideBusy: {fn: this.onHideBusy, scope: this}
            }
        });
        this.callParent();
        this.getControlAction("ToggleLayout" + this.viewLayout).each(function (n) {
            n.toggleUIOnly(!0)
        })
    },
    onDestroy: function () {
    ...
    initLabels: function () {
        this.emptyViewText = StolenTech.Util.Language.getEntry("Message.EmptyView");
    ...
    initActions: function () {
        this.addControlActions([{
            ...
            languageKey: "Label.Layout.Content",
            iconName: "Content"
        }, {actionName: "ToggleItemCheckBoxes", languageKey: "Label.ItemCheckBoxes"}, {
            actionName: "Refresh",
            languageKey: "Label.Refresh.Verb",
            iconName: "Refresh"
        }, {actionName: "Expand", languageKey: "Label.Expand"}, {
            actionName: "Collapse",
            languageKey: "Label.Collapse"
        }, {actionName: "Up", iconName: "Up"}], this.statics().sprite)
    },
    initStores: function (n, t) {
        this.navigationStore = new Ext.data.TreeStore(Ext.merge({
            root: {
                ...
                name: "",
                children: [],
                iconCls: this.statics().sprite.getIcon("Home").getIconCls()
            }, listeners: {load: {fn: this.onNavigationStoreLoad, scope: this}}
        }, n));
        this.viewStore = new Ext.data.Store(Ext.merge({
            listeners: {
                datachanged: {
                    ...
                    scope: this
                }, load: {fn: this.onViewStoreLoad, scope: this}
            }
        }, t))
    },
    getNavigationColumnsConfig: Ext.emptyFn,
    getViewColumnsConfig: Ext.emptyFn,
    createRibbon: function () {
        return new StolenTech.UI.Ribbon({
            region: "north",
            collapsed: this.collapseRibbon,
            responsiveConfig: {"height < 500": {collapsed: !0}, "height >= 500": {collapsed: this.collapseRibbon}},
            items: [{
                itemId: "homeTab",
                title: StolenTech.Util.Language.getEntry("Label.Home"),
                items: [{
                    itemId: "selectGroup",
                    title: StolenTech.Util.Language.getEntry("Label.Select"),
                    layout: "vbox",
                ...
                itemId: "viewTab",
                title: StolenTech.Util.Language.getEntry("Label.View.Noun"),
                items: [{
                    itemId: "panesGroup",
                    title: StolenTech.Util.Language.getEntry("Label.Panes"),
                    ...
                    itemId: "layoutGroup",
                    title: StolenTech.Util.Language.getEntry("Label.Layout"),
                    items: [{
                        xtype: "container",
                        layout: {type: "vbox", align: "stretchmax"},
                        defaults: {allowDepress: !1, textAlign: "left"},
                        items: [this.applyControlAction({toggleGroup: this.id + "layoutGroup"}, "ToggleLayoutExtraLargeIcons", 16), this.applyControlAction({toggleGroup: this.id + "layoutGroup"}, "ToggleLayoutMediumIcons", 16), this.applyControlAction({toggleGroup: this.id + "layoutGroup"}, "ToggleLayoutDetails", 16)]
                    }, {
                        xtype: "container",
                        layout: {type: "vbox", align: "stretchmax"},
                        defaults: {allowDepress: !1, textAlign: "left"},
                        items: [this.applyControlAction({toggleGroup: this.id + "layoutGroup"}, "ToggleLayoutLargeIcons", 16), this.applyControlAction({toggleGroup: this.id + "layoutGroup"}, "ToggleLayoutSmallIcons", 16), this.applyControlAction({toggleGroup: this.id + "layoutGroup"}, "ToggleLayoutTiles", 16)]
                    }]
                }, {
                    itemId: "showHideGroup",
                    title: StolenTech.Util.Language.getEntry("Label.ShowHide"),
                    layout: "vbox",
                    items: [this.applyControlAction({
                        xtype: "checkboxfield",
    ...
    createNavigationBar: function () {
        var n = this.getNavigationColumnsConfig(), t = n && n.length ? n[0].dataIndex : undefined;
        return new Ext.toolbar.Toolbar({
            ...
            }, "Up", 16), new StolenTech.UI.Breadcrumb({
                itemId: "breadcrumb",
                region: "north",
                buttonUI: "default-toolbar",
                flex: 1,
                defaults: {focusable: !1},
                store: this.navigationStore,
                displayField: t,
                overflowHandler: "scroller",
                listeners: {selectionchange: {fn: this.onNavigationSelectionChange, scope: this}},
            ...
            }, "Refresh", 16), {xtype: "tbspacer", width: 12}, new StolenTech.UI.SearchField({
                itemId: "searchBox",
                width: 200,
                listeners: {scope: this, buffer: 500, change: this.onSearchBoxChange},
                enableConditions: {
                    checkFn: function () {
    ...
    createNavigationPane: function (n) {
        return new Ext.tree.Panel(Ext.mergeEx({
            region: "west",
            responsiveConfig: {"width < 500": {collapsed: !0}, "width >= 500": {collapsed: !1}},
            split: {hideSplitterWhenCollapsed: !0},
            collapsible: !0,
            animCollapse: !1,
            animate: !1,
            header: !1,
            ...
            useArrows: !0,
            rootVisible: !1,
            title: StolenTech.Util.Language.getEntry("Label.NavigationPane"),
            width: 200,
            store: this.navigationStore,
            columns: this.getNavigationColumnsConfig(),
            hideHeaders: !0,
            ...
            viewConfig: {
                ...
                listeners: {
                    afterrender: function (n) {
                        var t = n.getColumnManager().getColumns()[0];
                        n.toolTip = new Ext.tip.ToolTip({
                            ...
                            listeners: {
                                render: function (n) {
                                    ...
                                    var r = n.getRecord(i.triggerElement), u, f;
                                    if (!r) return !1;
                                    u = r.data[t.dataIndex];
                                    f = t.innerRenderer ? t.innerRenderer(u, null, r) : u;
                                    i.update(f)
                                }
                            }
                        })
                    },
                    containercontextmenu: {fn: this.onNavigationViewContainerContextMenu, scope: this},
                    itemcontextmenu: {fn: this.onNavigationViewItemContextMenu, scope: this},
                    itemlongpress: {fn: this.onNavigationViewItemContextMenu, scope: this},
                    viewready: {
                        fn: function (n) {
    ...
    createCenterPane: function (n) {
        return new StolenTech.UI.MultiView(Ext.mergeEx({
            region: "center",
            ...
            getItemIconCls: {fn: this.getItemIconCls, scope: this},
            getItemThumbnailSrc: {fn: this.getItemThumbnailSrc, scope: this},
            listeners: {
                scope: this,
    ...
    createPreviewPane: function () {
        return new Ext.panel.Panel({
            ...
            animCollapse: !1,
            header: !0,
            title: StolenTech.Util.Language.getEntry("Label.PreviewPane"),
            width: 200
        })
    },
    ...
    createDetailsPane: function () {
        return new Ext.panel.Panel({
            ...
            animCollapse: !1,
            header: !0,
            title: StolenTech.Util.Language.getEntry("Label.DetailsPane"),
            width: 200
        })
    },
    ...
    createStatusBar: function (n) {
        return new StolenTech.UI.MultiViewStatusBar({
            region: "south",
            multiView: n,
            getSelectionStatusText: {fn: this.getSelectionStatusText, scope: this}
        })
    },
    ...
    createMessageBox: function () {
        return new StolenTech.UI.MessageBox({
            buttonText: {
                ok: StolenTech.Util.Language.getEntry("Label.OK"),
                yes: StolenTech.Util.Language.getEntry("Label.Yes"),
                no: StolenTech.Util.Language.getEntry("Label.No"),
                cancel: StolenTech.Util.Language.getEntry("Label.Cancel")
            }
        })
    },
    createChildWindow: function (n) {
        var t = this.childWindows[n.childWindowId], i;
        if (t) t.minimized && t.restore(); else if (i = this.getChildWindowSize(), n.minWidth > i.width && (n.minWidth = i.width), n.minHeight > i.height && (n.minHeight = i.height), t = new StolenTech.UI.Window(Ext.apply({
            layout: "fit",
            width: i.width,
            height: i.height,
            resizable: !0,
    ...
    getChildWindowSize: function (n) {
        n = n || 90;
        var t = this.getSize();
        return t.width = Math.round(t.width * n / 100), t.height = Math.round(t.height * n / 100), t.width > 1600 && (t.width = 1600), t.height > 1200 && (t.height = 1200), t
    },
    getMinimizeOffsets: function () {
        return [10, (this.getBox().bottom - this.centerPane.getBox().bottom) * -1]
    },
    ...
    createViewItemContextMenu: function () {
        return new Ext.menu.Menu({listeners: {beforeshow: {fn: this.onViewItemContextMenuBeforeShow, scope: this}}})
    },
    ...
    onServerHandlerMethodEnd: function (n, t, i) {
        ...
        i && (i.sessionExpired ? this.confirmRefreshPage() : this.messageBox.showError(i))
    },
    confirmRefreshPage: function () {
        this.messageBox.showConfirm({
            title: StolenTech.Util.Language.getEntry("Label.RefreshPage"),
            message: StolenTech.Util.Language.getEntry("Message.SessionExpiredRefresh", 10),
            fn: function (n) {
                n === "ok" && StolenTech.Util.Dom.refreshPage()
            },
            buttons: Ext.Msg.OKCANCEL,
            countDownConfig: {buttonId: "ok", seconds: 10}
        })
    },
    ...
    setNavigationSelection: function (n) {
        var u = this.navigationSelection, i, r, t;
    ...
    onShowBusy: function (n) {
        ...
        if (n.isNode) {
            ...
            t.busyActive = !0;
            i = Ext.get(t.getOwnerTree().getView().getNode(t));
            i && i.down(".x-tree-icon").addCls("x-loading")
        } else r = this.navigationBar && this.navigationBar.getComponent("breadcrumb"), r ? r.showBusy() : this.statusBar && this.statusBar.showBusy()
    },
    onHideBusy: function (n) {
        ...
        if (n.isNode) {
            ...
            t.busyActive = !1;
            i = Ext.get(t.getOwnerTree().getView().getNode(t));
            i && i.down(".x-tree-icon").removeCls("x-loading")
        } else r = this.navigationBar && this.navigationBar.getComponent("breadcrumb"), r ? r.hideBusy() : this.statusBar && this.statusBar.hideBusy()
    },
        ...
        if (n.isMenuItem) {
            ...
            switch (t) {
                case this.navigationViewContextMenu:
                    return StolenTech.UI.ExplorerViewActionContext.NavigationView;
                case this.navigationViewItemContextMenu:
                    return StolenTech.UI.ExplorerViewActionContext.NavigationViewItem;
                case this.viewItemContextMenu:
                    return StolenTech.UI.ExplorerViewActionContext.ViewItem
            }
        }
        return StolenTech.UI.ExplorerViewActionContext.View
    },
    ...
    onActionToggleItemCheckBoxes: function (n) {
        this.viewCheckboxSelection = n.checked;
...
StolenTech.UI.ExplorerViewLayoutType = {
    ExtraLargeIcons: 1,
    LargeIcons: 2,
    MediumIcons: 3,
    SmallIcons: 4,
...
StolenTech.UI.ExplorerViewActionContext = {NavigationView: 1, NavigationViewItem: 2, View: 3, ViewItem: 4};
Ext.define("StolenTech.FileUltimate.FileTypeInfo", {
    singleton: !0,
    baseFileIcons: {},
    fileIcons: {},
    fileIconMappings: {},
    ...
    mediaPlayerTypes: {
        ...
        webm: {isVideo: !0},
        ogv: {isVideo: !0},
        mp4v: {isVideo: !0, format: "mp4"},
        "3g2": {isVideo: !0, format: "mp4"},
        "3gp": {isVideo: !0, format: "mp4"},
        mkv: {isVideo: !0, format: "mp4"},
        flv: {isVideo: !0},
        aac: {isAudio: !0},
        f4a: {isAudio: !0},
        mp3: {isAudio: !0},
...
Ext.define("StolenTech.UI.MediaPlayer", {
    ...
    onRender: function () {
        ...
        Ext.Loader.loadScript({
            url: [StolenTech.Util.Path.combine(this.libraryPath, "jwplayer.js", StolenTech.Util.Path.forwardSlash), StolenTech.Util.Path.combine(this.libraryPath, "skins/tube.css", StolenTech.Util.Path.forwardSlash)],
            onLoad: this.onLibraryLoaded,
            scope: this
        });
        Ext.Loader.setConfig({disableCaching: n})
    },
    onLibraryLoaded: function () {
        this.videoEl = this.el.appendChild({tag: "div"});
        this.player = jwplayer(this.videoEl.id).setup({
            file: this.src,
            type: this.format,
            title: this.title,
            description: this.description,
            image: StolenTech.Util.Path.combine(this.libraryPath, this.isAudio ? "skins/audio.jpg" : "skins/video.jpg", StolenTech.Util.Path.forwardSlash),
            width: "100%",
            height: "100%",
            skin: {
                controlbar: {icons: this.iconColor, iconsActive: this.hoverColor},
                menus: {textActive: this.hoverColor},
                tooltips: {text: this.hoverColor},
                timeslider: {progress: this.hoverColor}
            },
            autostart: !0,
            playbackRateControls: !0,
            playbackRates: [.25, .5, .75, 1, 1.25, 1.5, 2],
            forceLocalizationDefaults: !0,
            flashplayer: StolenTech.Util.Path.combine(this.libraryPath, "jwplayer.flash.swf", StolenTech.Util.Path.forwardSlash)
        });
        var n = this;
        this.player.on("meta", function (t) {
            var u = t.metadata || t, i = u.width, r = u.height;
        ...
        this.player.on("setupError", function (t) {
            switch (t.code) {
                case 102630:
                    n.fireEvent("mediaformaterror", t);
                    break;
                default:
                    n.fireEvent("setuperror", t)
            }
        });
...
Ext.define("StolenTech.FileUltimate.FileManager", {
    extend: "StolenTech.UI.ExplorerView",
    statics: {sprite: new StolenTech.UI.Sprite("filemanagericons")},
    config: {
        sortRootFolders: !0,
    ...
    chooseButton: null,
    initComponent: function () {
        if (this.hasListener("loading") && this.fireEventEx("loading"), this.clipboard = {isEmpty: !0}, this.excludedExtensionsForPreview = this.excludedExtensionsForPreview ? Ext.Array.toMap(this.excludedExtensionsForPreview.match(/[^,\s]+/g), function (n) {
            ...
            this.chooserType = StolenTech.FileUltimate.FileManagerChooserType[this.chooserType];
            this.chooseButton = new Ext.button.Button(this.applyControlAction({
                enableConditions: {
                    itemTypes: function (n) {
                        switch (n.chooserType) {
                            case StolenTech.FileUltimate.FileManagerChooserType.Folder:
                                return {Folder: {multiple: n.chooserMultipleSelection}};
                            case StolenTech.FileUltimate.FileManagerChooserType.FileOrFolder:
                                return {
                                    Folder: {multiple: n.chooserMultipleSelection},
                                    File: {multiple: n.chooserMultipleSelection}
                                };
                            default:
                                return {File: {multiple: n.chooserMultipleSelection}}
                        }
                    }(this)
                }, minWidth: 75, disabled: !0
            }, "Choose"));
            var n = new Ext.toolbar.Toolbar({
                ...
                items: [this.chooseButton, {
                    text: StolenTech.Util.Language.getEntry("Label.Cancel"),
                    minWidth: 75,
                    handler: function () {
                        this.hide()
                    },
        ...
        this.hasListener("loaded") && this.fireEventEx("loaded")
    },
    afterRender: function () {
        ...
        this.downloadIframe.el.dom.ownerComponent = this;
    ...
    onBoxReady: function () {
        this.loadInitialFolder() || this.setNavigationSelection(this.navigationStore.getRoot());
        this.callParent(arguments)
    },
    initLabels: function () {
        this.callParent();
        this.emptyViewText = StolenTech.Util.Language.getEntry("Message.EmptyFolder");
        this.emptyNavigationViewText = StolenTech.Util.Language.getEntry("Message.NoRootFolders")
    },
    initActions: function () {
        this.callParent();
        this.addControlActions([{
            ...
            iconName: "Cut"
        }, {actionName: "Copy", languageKey: "Label.Copy.Verb", iconName: "Copy"}, {
            actionName: "Paste",
            languageKey: "Label.Paste.Verb",
            iconName: "Paste"
        }, {actionName: "Delete", languageKey: "Label.Delete", iconName: "Delete"}, {
            actionName: "Rename",
            languageKey: "Label.Rename",
            iconName: "Rename"
        }, {actionName: "NewFolder", languageKey: "Label.NewFolder", iconName: "NewFolder"}, {
            actionName: "NewFile",
            languageKey: "Label.NewFile",
            iconName: "NewFile"
        }, {actionName: "Download", languageKey: "Label.Download.Verb", iconName: "Download"}, {
            actionName: "Preview",
            languageKey: "Label.Preview.Verb",
            iconName: "Preview"
        }, {actionName: "Upload", languageKey: "Label.Upload.Verb", iconName: "Upload"}, {
            actionName: "Open",
            languageKey: "Label.Open.Verb",
            iconName: "Open"
        }, {actionName: "AddToZip", languageKey: "Label.AddToZip", iconName: "AddToZip"}, {
            actionName: "ExtractAll",
            languageKey: "Label.ExtractAll",
            iconName: "ExtractAll"
        }, {actionName: "ExtractAllTo", languageKey: "Label.ExtractAllTo"}, {
            actionName: "ExtractAllHere",
            languageKey: "Label.ExtractAllHere"
        }, {actionName: "Choose", languageKey: "Label.Choose"}, {
            actionName: "ToggleFileExtensions",
            languageKey: "Label.FileExtensions"
        }], this.statics().sprite)
    },
    initStores: function () {
        var t = {
            model: "StolenTech.FileUltimate.FolderNodeModel",
            proxy: this.getServerHandlerMethodProxy({
                methodInfoCallback: function (n) {
                    return {
                        name: "ExpandFolder",
                        parameters: {isRefresh: n.config.isRefresh == !0, path: n.config.node.getPathData().fullPath}
                    }
                }, readRecordsCallback: this.readFolderNodeRecords, scope: this
            }),
            clearOnLoad: !1,
            sorters: [{property: "itemType", direction: "ASC"}, {property: "name", direction: "ASC"}]
        }, i = {
            model: "StolenTech.FileUltimate.FolderViewModel",
            proxy: this.getServerHandlerMethodProxy({
                methodInfoCallback: function (n) {
                    return {
                        name: "ListFolder",
                ...
                }, readRecordsCallback: this.readFolderViewRecords, scope: this
            }),
            grouper: {property: "itemType", direction: "ASC"},
        ...
        Ext.override(this.navigationStore, {
            fillNode: function (t, i) {
                ...
                return f = this.sortOnLoad, this.sortOnLoad = !1, e = this.sorters, this.sorters = n, this.callParent(arguments), this.sortOnLoad = f, this.sorters = e, this.sortOnLoad && t.sort(null, !1, !0), t.childNodes.length === 0 ? t.set({
                    ...
                    expanded: !1,
                    expandable: !1
                }) : (t.set({leaf: !1, expanded: !1, expandable: !0}), t.expand()), i
            }
        });
        this.loadRootFolders()
    },
    getNavigationColumnsConfig: function () {
        var n = this;
        return [{
            xtype: "treecolumn",
            text: StolenTech.Util.Language.getEntry("Label.Column.Name"),
            dataIndex: "name",
            flex: 1,
            renderer: function (t, i, r) {
                return t = !n.showFileExtensions && r.data.itemType === StolenTech.FileUltimate.FileManagerItemType.File ? StolenTech.Util.Path.getFileNameWithoutExtension(t) : t, Ext.htmlEncode(t)
            }
        }]
    },
        ...
        var f = this, u = {
            name: {
                ...
                formatterFn: function (n, t) {
                    return !f.showFileExtensions && t.data.itemType === StolenTech.FileUltimate.FileManagerItemType.File ? StolenTech.Util.Path.getFileNameWithoutExtension(n) : n
                },
                htmlEncode: !0,
                hideable: !1,
                isPrimary: !0,
            ...
            dateModified: {
                text: StolenTech.Util.Language.getEntry("Label.Column.DateModified"),
                dataIndex: "dateModified",
                formatterFn: function (n) {
                    return StolenTech.Util.Culture.formatShortDateTime(n)
                },
                isToolTipValue: !0,
                width: 125
            },
            type: {
                text: StolenTech.Util.Language.getEntry("Label.Column.Type"),
                dataIndex: "type",
                isTileFirstValue: !0,
                tileFormatterFn: function (n, t) {
                    return t.data.itemType === StolenTech.FileUltimate.FileManagerItemType.File ? n : ""
                },
                htmlEncode: !0,
                isToolTipValue: !0,
                width: 125
            ...
            size: {
                text: StolenTech.Util.Language.getEntry("Label.Column.Size"),
                dataIndex: "size",
                align: "right",
                formatterFn: function (n) {
                    return StolenTech.Util.Culture.formatKBSize(n)
                },
                isTileSecondValue: !0,
                tileFormatterFn: function (n, t) {
                    return t.data.itemType === StolenTech.FileUltimate.FileManagerItemType.File ? StolenTech.Util.Culture.formatByteSize(n) : ""
                },
                isToolTipValue: !0,
                width: 85
            }
    ...
    createRibbon: function () {
        var n = this.callParent(), t = n.down("#homeTab"), i;
        return n.insertGroup(t, 0, {
            itemId: "clipboardGroup",
            title: StolenTech.Util.Language.getEntry("Label.Clipboard"),
            items: [this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Copy"]},
                        Folder: {permissions: ["Copy"]},
                        File: {permissions: ["Copy"]}
                    }
                },
                enableConditions: {itemTypes: {Folder: {multiple: !0}, File: {multiple: !0}}},
                iconAlign: "top",
                rowspan: 3
            }, "Copy", 32), this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Paste"]},
                        Folder: {permissions: ["Paste"]},
                        File: {permissions: ["Paste"]}
                    }
                }, enableConditions: {
                    checkFn: function () {
                        return this.isNavigationSelectionValid && !this.clipboard.isEmpty
                    }, scope: this
                }, iconAlign: "top", rowspan: 3
            }, "Paste", 32), {
                xtype: "container",
                layout: {type: "vbox", align: "stretchmax"},
                items: [this.applyControlAction({
                    showConditions: {
                        itemTypes: {
                            RootFolder: {permissions: ["Cut"]},
                            Folder: {permissions: ["Cut"]},
                            File: {permissions: ["Cut"]}
                        }
                    }, enableConditions: {itemTypes: {Folder: {multiple: !0}, File: {multiple: !0}}}
                }, "Cut", 16)]
            }]
        }), n.insertGroup(t, 1, {
            itemId: "organizeGroup",
            title: StolenTech.Util.Language.getEntry("Label.Organize"),
            items: [this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Delete"]},
                        Folder: {permissions: ["Delete"]},
                        File: {permissions: ["Delete"]}
                    }
                }, enableConditions: {itemTypes: {Folder: {multiple: !0}, File: {multiple: !0}}}, iconAlign: "top"
            }, "Delete", 32), this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Rename"]},
                        Folder: {permissions: ["Rename"]},
                        File: {permissions: ["Rename"]}
                    }
                }, enableConditions: {itemTypes: {Folder: {}, File: {}}}, iconAlign: "top"
            }, "Rename", 32)]
        }), n.insertGroup(t, 2, {
            itemId: "newGroup",
            title: StolenTech.Util.Language.getEntry("Label.New"),
            items: [this.applyControlAction({
                showConditions: {
                    itemTypes: {
            ...
            itemId: "transferGroup",
            title: StolenTech.Util.Language.getEntry("Label.Transfer.Verb"),
            items: [this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Download"]},
                        Folder: {permissions: ["Download"]},
            ...
            itemId: "openGroup",
            title: StolenTech.Util.Language.getEntry("Label.Open.Verb"),
            items: [this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Download", "ListSubfolders"]},
                        Folder: {permissions: ["Download", "ListSubfolders"]},
                        File: {permissions: ["Download", "ListSubfolders"]}
                    }
                },
                enableConditions: {
                    itemTypes: {
                        Folder: {},
                        File: {parentPermissions: ["Download"], extensionCheckFn: this.isOpenInBrowserType, scope: this}
                    }
                },
                iconAlign: "top"
                ...
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Preview"]},
            ...
            itemId: "compressionGroup",
            title: StolenTech.Util.Language.getEntry("Label.Compression"),
            items: [this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Compress"]},
                        Folder: {permissions: ["Compress"]},
                        File: {permissions: ["Compress"]}
                    }
                }, enableConditions: {itemTypes: {Folder: {multiple: !0}, File: {multiple: !0}}}, iconAlign: "top"
            }, "AddToZip", 32), this.applyControlAction({
                showConditions: {
                    itemTypes: {
                        RootFolder: {permissions: ["Extract"]},
                        Folder: {permissions: ["Extract"]},
                        File: {permissions: ["Extract"]}
                    }
                },
                enableConditions: {itemTypes: {File: {extensionCheckFn: this.getArchiveType, scope: this}}},
                iconAlign: "top",
                menu: {items: [this.applyControlAction({}, "ExtractAllTo"), this.applyControlAction({}, "ExtractAllHere")]}
            }, "ExtractAll", 32)]
        }), i = n.down("#viewTab"), i.down("#showHideGroup").add(this.applyControlAction({
            xtype: "checkboxfield",
            checked: this.showFileExtensions
        }, "ToggleFileExtensions")), Crypto.MD5(this.id + this.stateId) !== this.hash && n.tabBar.insert(n.tabBar.items.findIndex("xtype", "tbfill") + 1, {
            xtype: "component",
            autoEl: {
                tag: "a",
                href: "https://www.StolenTech.com/fileultimate/buy",
                target: "_blank",
                html: "FileUltimate (unlicensed) - Purchase a license",
                style: {color: "#000080", marginRight: "10px", lineHeight: "22px"}
            }
        }), n
    },
            ...
            viewConfig: {
                plugins: {
                    gttreedragdrop: {
                        ...
                        enableDrop: !0,
                        ddGroup: "fileManager"
                    }, gtviewnativedrop: {enableNativeDrop: !0}
                },
                listeners: {
                    scope: this,
    ...
    createNavigationViewItemContextMenu: function () {
        ...
        }, "Collapse"), this.applyControlAction({}, "Refresh", 16), {xtype: "menuseparator"}, this.applyControlAction({}, "Open", 16), this.applyControlAction({
            showConditions: {
                itemTypes: {
                    Folder: {parentPermissions: ["Download"]},
                    File: {parentPermissions: ["Download"]}
                }
            }
        ...
        }, "Upload", 16), {xtype: "menuseparator"}, this.applyControlAction({
            showConditions: {
                itemTypes: {
                    Folder: {parentPermissions: ["Compress"]},
                    File: {parentPermissions: ["Compress"]}
                }
            }
        ...
        }, "ExtractAll", 16), {xtype: "menuseparator"}, this.applyControlAction({
            showConditions: {
                itemTypes: {
                    Folder: {parentPermissions: ["Cut"]},
                    File: {parentPermissions: ["Cut"]}
                }
            }
        }, "Cut", 16), this.applyControlAction({
            showConditions: {
                itemTypes: {
                    Folder: {parentPermissions: ["Copy"]},
                    File: {parentPermissions: ["Copy"]}
                }
            }
        ...
        }, "Paste", 16), {xtype: "menuseparator"}, this.applyControlAction({
            showConditions: {
                itemTypes: {
                    Folder: {parentPermissions: ["Delete"]},
                    File: {parentPermissions: ["Delete"]}
                }
            }
        }, "Delete", 16), this.applyControlAction({
            showConditions: {
                itemTypes: {
                    Folder: {parentPermissions: ["Rename"]},
                    File: {parentPermissions: ["Rename"]}
                }
            }
        }, "Rename", 16), {xtype: "menuseparator"}, this.applyControlAction({
            showConditions: {
                itemTypes: {
                    RootFolder: {permissions: ["Create"]},
                    Folder: {permissions: ["Create"]},
    ...
    createViewContainerContextMenu: function () {
        ...
        }, "Refresh", 16), {xtype: "menuseparator"}, this.applyControlAction({
            showConditions: {
                itemTypes: {
                    RootFolder: {permissions: ["Upload"]},
                    Folder: {permissions: ["Upload"]},
        ...
        }, "NewFolder", 16), {xtype: "menuseparator"}, this.applyControlAction({}, "SelectAll", 16)]), n
    },
    createViewItemContextMenu: function () {
        var n = this.callParent();
        ...
        }, "Choose"), {xtype: "menuseparator"}]), n.add([this.applyControlAction({
            showConditions: {
                itemTypes: {
                    File: {
                        parentPermissions: ["Preview"],
            ...
            showConditions: {
                itemTypes: {
                    Folder: {
                        ...
                        multiple: !0
                    }, File: {parentPermissions: ["Download"], multiple: !0}
                }
            }
        }, "Download", 16), this.applyControlAction({
            showConditions: {
            ...
            showConditions: {
                itemTypes: {
                    Folder: {
                        ...
                        multiple: !0
                    }, File: {parentPermissions: ["Compress"], multiple: !0}
                }
            }
        }, "AddToZip", 16), this.applyControlAction({
            showConditions: {
            ...
            showConditions: {
                itemTypes: {
                    Folder: {
                        ...
                        multiple: !0
                    }, File: {parentPermissions: ["Cut"], multiple: !0}
                }
            }
        }, "Cut", 16), this.applyControlAction({
            showConditions: {
                itemTypes: {
                    Folder: {
                        ...
                        multiple: !0
                    }, File: {parentPermissions: ["Copy"], multiple: !0}
                }
            }
        }, "Copy", 16), this.applyControlAction({
            showConditions: {
            ...
            showConditions: {
                itemTypes: {
                    Folder: {
                        ...
                        multiple: !0
                    }, File: {parentPermissions: ["Delete"], multiple: !0}
                }
            }
        }, "Delete", 16), this.applyControlAction({
            showConditions: {
        ...
        }, "NewFolder", 16), {xtype: "menuseparator"}, this.applyControlAction({}, "InvertSelection", 16)]), n
    },
    loadRootFolders: function () {
        this.navigationStore.sortOnLoad = this.sortRootFolders;
        var n = this.navigationStore.getRoot(),
            t = this.readFolderNodeRecords({config: {node: n}}, {Folders: this.rootFolders});
    ...
    loadInitialFolder: function () {
        ...
        u = this.navigationStore.getRoot();
        t = -1;
        switch (Ext.String.trim(this.initialFolder).toLowerCase()) {
            case"first":
                t = 0;
                break;
            case"last":
                t = u.childNodes.length - 1
        }
        if (t >= 0 && t < u.childNodes.length) return this.setNavigationSelection(this.navigationStore.getAt(t)), !0;
        if (n = this.initialFolder, n.charAt(0) === "[" && (i = n.indexOf("]:")) > -1) f = n.substr(1, i - 1), e = n.substr(i + 2).split(StolenTech.Util.Path.backSlash); else if ((i = n.indexOf(":")) > -1) f = n.substr(0, i), e = n.substr(i + 1).split(StolenTech.Util.Path.backSlash); else return !1;
        var s = [f].concat(Ext.Array.filter(e, function (n) {
            return n
        })), r = u, o = 0, h = this, c = function () {
            var n = r.findChildNodeByName(s[o]);
            return n ? (r = n, o === s.length - 1 ? h.setNavigationSelection(r) : (o++, r.expand(!1, c)), !0) : (r !== u && h.setNavigationSelection(r), !1)
        };
        return c()
    },
    readFolderNodeRecords: function (n, t) {
        var o = n.config.node, s = t.Folders, h = s.length, r, u, f, i, e;
        for (o.isRoot() ? (r = StolenTech.FileUltimate.FileManagerItemType.RootFolder, u = StolenTech.FileUltimate.FileTypeInfo.getBaseIconCls("RootFolder", 16)) : (r = StolenTech.FileUltimate.FileManagerItemType.Folder, u = StolenTech.FileUltimate.FileTypeInfo.getBaseIconCls("Folder", 16)), f = [], i = 0; i < h; i++) e = this.createFolderNodeRecord(s[i], o, r, u), e != null && f.push(e);
        return f
    },
    readFolderViewRecords: function (n, t) {
        for (var h, u, b, i = n.config.node, v = t.Folders, e = v.length, y = t.Files, p = y.length, r, o = new Array(e + p), s = [], f = 0; f < e; f++) h = v[f], o[f] = this.createFolderViewRecord(h, i, StolenTech.FileUltimate.FileManagerItemType.Folder), r = this.createFolderNodeRecord(h, i, StolenTech.FileUltimate.FileManagerItemType.Folder, StolenTech.FileUltimate.FileTypeInfo.getBaseIconCls("Folder", 16)), r != null && s.push(r);
        for (u = 0; u < p; u++) {
            var c = y[u], l, w = StolenTech.Util.Path.getExtension(c[0], !0), a = this.getArchiveBrowsingType(w);
            a && (l = !a.isReadOnly && i.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Edit) && i.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Compress) ? i.data.permissions : i.data.permissions & (StolenTech.FileUltimate.FileManagerPermissionTypes.ListSubfolders | StolenTech.FileUltimate.FileManagerPermissionTypes.ListFiles | StolenTech.FileUltimate.FileManagerPermissionTypes.Download | StolenTech.FileUltimate.FileManagerPermissionTypes.Preview | StolenTech.FileUltimate.FileManagerPermissionTypes.Copy), b = [c[0], l, null, !0], r = this.createFolderNodeRecord(b, i, StolenTech.FileUltimate.FileManagerItemType.File, StolenTech.FileUltimate.FileTypeInfo.getIconCls(w, 16)), r != null && s.push(r));
            r = o[e + u] = this.createFolderViewRecord(c, i, StolenTech.FileUltimate.FileManagerItemType.File);
    ...
    createFolderNodeRecord: function (n, t, i, r) {
        var e = {
            ...
            hash: n[4],
            iconCls: r
        }, u = t.findChildNodeByName(e.name), f;
        return u ? (u.set(e), u.commit(), u.isExisting = !0, null) : (f = new StolenTech.FileUltimate.FolderNodeModel(e), f.phantom = !1, f.childrenNotLoadedYet = !0, f)
    },
    createFolderViewRecord: function (n, t, i) {
        return i === StolenTech.FileUltimate.FileManagerItemType.Folder ? new StolenTech.FileUltimate.FolderViewModel({
            itemType: i,
            name: n[0],
            permissions: n[1] != null ? n[1] : t.data.permissions,
            fileTypes: n[2] != null ? n[2] : t.data.fileTypes,
            ...
            systemType: n[4],
            dateModified: n[5]
        }) : new StolenTech.FileUltimate.FolderViewModel({
            itemType: i,
            name: n[0],
            size: n[1],
            systemType: n[2],
    ...
    getItemIconCls: function (n, t) {
        var i = n.data;
        switch (i.itemType) {
            case StolenTech.FileUltimate.FileManagerItemType.RootFolder:
                return StolenTech.FileUltimate.FileTypeInfo.getBaseIconCls("RootFolder", t);
            case StolenTech.FileUltimate.FileManagerItemType.Folder:
                return StolenTech.FileUltimate.FileTypeInfo.getBaseIconCls("Folder", t);
            case StolenTech.FileUltimate.FileManagerItemType.File:
                return StolenTech.FileUltimate.FileTypeInfo.getIconCls(i.extension, t);
            default:
                return ""
        }
    },
    getItemThumbnailSrc: function (n, t) {
        var i = n.data;
        return i.itemType != StolenTech.FileUltimate.FileManagerItemType.File || i.size == 0 ? "" : this.getThumbnailType(i.extension) ? this.getServerHandlerMethodUrl("GetThumbnail", {
            path: this.navigationSelection.getPathData().fullPath,
            fileName: i.name,
            maxSize: t,
    ...
    setNavigationSelection: function (n, t, i) {
        var o = this.navigationSelection, f, e, r, u, s;
        if (this.callParent([n]), this.isNavigationSelectionValid) {
            if (!i && this.navigationSelection != o) if (this.navigationSelection.isRoot()) {
                for (f = this.navigationSelection.childNodes, e = [], r = 0; r < f.length; r++) u = f[r], s = new StolenTech.FileUltimate.FolderViewModel({
                    itemType: StolenTech.FileUltimate.FileManagerItemType.RootFolder,
                    name: u.data.name,
                ...
                this.hasListener("folderChanged") && this.fireEventEx("folderChanged", new StolenTech.UI.EventArgs({folder: this.getEventFolder()}))
            } else this.viewStore.load({node: this.navigationSelection, previousNode: o, callback: t})
    ...
    onViewStoreLoad: function (n, t, i, r) {
        var u = r.config.node, f = r.config.previousNode, e = r.config.folderNodeRecords;
        i ? (this.navigationStore.fillNode(u, e), u.data.expanded = !1, u.expand(), r.config.isRefresh || this.hasListener("folderChanged") && this.fireEventEx("folderChanged", new StolenTech.UI.EventArgs({folder: this.getEventFolder()}))) : this.setNavigationSelection(f, null, !0);
        this.callParent(arguments)
    },
    getSelectionStatusText: function (n) {
        var r = 0, u = n.length, t, i;
        if (u == 0) return "";
        for (t = 0; t < u; t++) {
            if (i = n[t].data, i.itemType != StolenTech.FileUltimate.FileManagerItemType.File) return "";
            r += i.size
        }
        return StolenTech.Util.Culture.formatByteSize(r)
    },
    onViewSelectionChange: function (n, t) {
        this.callParent(arguments);
        ...
        this.hasListener("selectionChanged") && this.fireEventEx("selectionChanged", new StolenTech.UI.EventArgs({items: this.getEventItems()}))
    },
    ...
    onViewDragStart: function (n, t, i) {
        var r, u;
        n.isTreeView ? (u = i.records[0], r = u.parentNode, i.copyAllowed = u.data.itemType !== StolenTech.FileUltimate.FileManagerItemType.RootFolder && r.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Copy), i.moveAllowed = u.data.itemType !== StolenTech.FileUltimate.FileManagerItemType.RootFolder && r.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Cut)) : (r = this.navigationSelection, i.copyAllowed = r.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Copy), i.moveAllowed = r.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Cut));
        i.copyAllowed || i.moveAllowed || t.proxy.setStatusNotAllowed()
    },
    onViewDropEnter: function (n, t, i, r, u) {
        var f, e;
        (u.copyAllowed || u.moveAllowed) && (f = n.getRecord(i), n.isTreeView || f.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Paste) || (f = this.navigationSelection, i = null), e = this.getViewDropAction(n, t, i, u, f), u.currentTarget = {
            target: i,
            record: f,
            action: e
    ...
    onViewDropKeyChange: function (n, t, i, r) {
        if (r.copyAllowed || r.moveAllowed) {
            var f = r.currentTarget.record, u = this.getViewDropAction(n, t, r.currentTarget.target, r, f);
            u !== r.currentTarget.action && (this.setViewDropStatus(i.proxy, f, u), r.currentTarget.action = u)
        }
    },
    onViewDrop: function (n, t, i, r, u) {
        return t.getKey() === t.ESC || !u.currentTarget || u.currentTarget.action !== StolenTech.FileUltimate.FileManagerDropAction.CopyTo && u.currentTarget.action !== StolenTech.FileUltimate.FileManagerDropAction.MoveTo ? !1 : (this.copyOrMove(u.currentTarget.action === StolenTech.FileUltimate.FileManagerDropAction.CopyTo ? StolenTech.FileUltimate.FileManagerClipboardAction.Copy : StolenTech.FileUltimate.FileManagerClipboardAction.Cut, u.view.isTreeView ? u.records[0].parentNode : this.navigationSelection, n.isTreeView ? u.currentTarget.record : u.currentTarget.target ? this.navigationSelection.findChildNodeByName(u.currentTarget.record.data.name) : this.navigationSelection, u.records), !0)
    },
    onViewContainerDropOver: function (n, t, i, r) {
        if ((r.copyAllowed || r.moveAllowed) && !r.currentTarget) {
            var u = this.navigationSelection, f = this.getViewDropAction(n, t, null, r, u);
            r.currentTarget = {target: null, record: u, action: f};
    ...
    onViewNativeDragEnter: function (n, t) {
        var i;
        n.isTreeView ? i = t.record : t.record ? (i = t.record, i.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Upload) || (i = this.navigationSelection)) : i = this.navigationSelection;
        t.uploadAllowed = i && i.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Upload);
        t.uploadAllowed && t.hasFiles ? this.setViewDropStatus(t.proxy, i, StolenTech.FileUltimate.FileManagerDropAction.UploadTo) : t.proxy.setStatusNotAllowed()
    },
    ...
    onViewNativeDrop: function (n, t) {
        var i, r, u;
        t.uploadAllowed && t.hasFiles && (n.isTreeView ? (i = t.record, r = StolenTech.UI.ExplorerViewActionContext.NavigationViewItem) : t.record ? (i = t.record, r = StolenTech.UI.ExplorerViewActionContext.ViewItem, i.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Upload) || (i = null, r = StolenTech.UI.ExplorerViewActionContext.View)) : (i = null, r = StolenTech.UI.ExplorerViewActionContext.View), this.contextMenuSelection = i, u = this, StolenTech.FileUltimate.FileDropHelper.getFilesFromEvent(t.e.browserEvent, function (n) {
            u.onActionUpload(null, null, r, function (t) {
                t.addFiles(n, !0)
            })
        }, function (n) {
            u.messageBox.showWarning(n)
        }))
    },
    setViewDropStatus: function (n, t, i) {
        switch (i) {
            case StolenTech.FileUltimate.FileManagerDropAction.Hidden:
                n.setStatusHidden();
                break;
            case StolenTech.FileUltimate.FileManagerDropAction.NotAllowed:
                n.setStatusNotAllowed();
                break;
            case StolenTech.FileUltimate.FileManagerDropAction.CopyTo:
                n.setStatusText(StolenTech.Util.Language.getEntry("Label.CopyTo", '<span class="x-dd-status-folder">' + t.data.name + "<\/span>") + "<br>" + StolenTech.Util.Language.getEntry("Label.HoldShiftToMove") + "<br>" + StolenTech.Util.Language.getEntry("Label.PressEscToCancel"), "x-dd-status-copyto");
                break;
            case StolenTech.FileUltimate.FileManagerDropAction.MoveTo:
                n.setStatusText(StolenTech.Util.Language.getEntry("Label.MoveTo", '<span class="x-dd-status-folder">' + t.data.name + "<\/span>") + "<br>" + StolenTech.Util.Language.getEntry("Label.HoldCtrlToCopy") + "<br>" + StolenTech.Util.Language.getEntry("Label.PressEscToCancel"), "x-dd-status-moveto");
                break;
            case StolenTech.FileUltimate.FileManagerDropAction.UploadTo:
                n.setStatusText(StolenTech.Util.Language.getEntry("Label.UploadTo", '<span class="x-dd-status-folder">' + t.data.name + "<\/span>") + "<br>" + StolenTech.Util.Language.getEntry("Label.PressEscToCancel"), "x-dd-status-uploadto")
        }
    },
    getViewDropAction: function (n, t, i, r, u) {
        if (i) {
            if (i === r.item) return StolenTech.FileUltimate.FileManagerDropAction.Hidden;
            if (!u.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Paste)) return StolenTech.FileUltimate.FileManagerDropAction.NotAllowed
        } else if (n.isTreeView || !u.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Paste)) return StolenTech.FileUltimate.FileManagerDropAction.NotAllowed;
        return t.ctrlKey ? r.copyAllowed ? StolenTech.FileUltimate.FileManagerDropAction.CopyTo : StolenTech.FileUltimate.FileManagerDropAction.NotAllowed : t.shiftKey ? r.moveAllowed ? StolenTech.FileUltimate.FileManagerDropAction.MoveTo : StolenTech.FileUltimate.FileManagerDropAction.NotAllowed : r.moveAllowed ? !i && n === r.view ? StolenTech.FileUltimate.FileManagerDropAction.Hidden : StolenTech.FileUltimate.FileManagerDropAction.MoveTo : r.copyAllowed ? StolenTech.FileUltimate.FileManagerDropAction.Hidden : StolenTech.FileUltimate.FileManagerDropAction.NotAllowed
    },
    getUIConditionFn: function (n, t, i, r, u) {
        var s, f, e, c, o, h;
        if (t && t.length > 1) for (f = {}, e = new StolenTech.FileUltimate.FolderItemModel, o = 0; o < t.length; o++) h = t[o], e.combinePermissionsOfRecord(h), f[h.data.itemType] = !0; else n && (s = Ext.Object.getKey(StolenTech.FileUltimate.FileManagerItemType, n.data.itemType), f = !1, n.data.itemType == StolenTech.FileUltimate.FileManagerItemType.File && (c = n.data.extension.toLowerCase()));
        return function (o, h, l) {
            ...
            if (f) {
                for (y in f) if (p = Ext.Object.getKey(StolenTech.FileUltimate.FileManagerItemType, +y), a = v.itemTypes[p], !a || !a.multiple) return !1;
    ...
    getThumbnailType: function (n) {
        var t = StolenTech.FileUltimate.FileTypeInfo.getThumbnailType(n);
        return t && (t.isImage && this.imageThumbnailsEnabled || t.isVideo && this.videoThumbnailsEnabled) ? t : null
    },
    getArchiveType: function (n) {
        return StolenTech.FileUltimate.FileTypeInfo.getArchiveType(n)
    },
    getArchiveBrowsingType: function (n) {
        return this.archiveBrowsingEnabled ? StolenTech.FileUltimate.FileTypeInfo.getArchiveType(n) : null
    },
    getImageViewerType: function (n) {
        return this.imageViewerEnabled ? StolenTech.FileUltimate.FileTypeInfo.getImageViewerType(n) : null
    },
    getMediaPlayerType: function (n) {
        return this.mediaPlayerEnabled ? StolenTech.FileUltimate.FileTypeInfo.getMediaPlayerType(n) : null
    },
    getDocumentViewerType: function (n) {
        return this.documentViewerEnabled ? StolenTech.FileUltimate.FileTypeInfo.getDocumentViewerType(n) : null
    },
    ...
    isOpenInBrowserType: function (n) {
        return this.openInBrowserEnabled || this.getArchiveBrowsingType(n)
    },
    setClipboard: function (n, t, i) {
        ...
        this.isNavigationSelectionValid && this.getControlAction("Paste").enable()
    },
    clearClipboard: function () {
        ...
        this.getControlAction("Paste").disable()
    },
    refreshFolderNode: function (n, t) {
        n == this.navigationSelection ? this.viewStore.load({
            ...
            isRefresh: !0,
            callback: t
        }) : this.navigationStore.load({node: n, isRefresh: !0, callback: t})
    },
    download: function (n, t) {
        var i, r;
        if (Ext.is.iOS && !StolenTech.Util.Dom.supports.AnchorDownloadAttribute) return this.downloadAndOpen(n, t);
        if (!n.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Download)) return !1;
        if (!this.hasListener("downloading") || (i = this.fireEventEx("downloading", new StolenTech.UI.EventArgs({
            ...
            return this.downloadForm.set({
                ...
                action: this.getServerHandlerMethodUrl("Download/" + StolenTech.Util.Path.getSafeFileNameForUrl(t.data.name))
            }), r = this.getServerHandlerMethodParameters({
                path: n.getPathData().fullPath,
                openInBrowser: !1,
                fileName: t.data.name
            }), Ext.Object.each(r, function (n, t) {
                this.downloadForm.createChild({tag: "input", name: n, type: "hidden"}).dom.value = t
    ...
    downloadAndOpen: function (n, t) {
        var e, f, o;
        if (!n.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Download)) return !1;
        if (!this.hasListener("downloading") || (e = this.fireEventEx("downloading", new StolenTech.UI.EventArgs({
            items: this.getEventItems(n, [t]),
            downloadFileName: t.data.name,
            openInBrowser: !0
        })), e !== !1)) {
            while (this.downloadForm.dom.firstChild) this.downloadForm.dom.removeChild(this.downloadForm.dom.firstChild);
            var r = n.getPathData(), i = t.data.name, u = t.data.extension.toLowerCase();
            return u === "htm" || u === "html" ? (this.downloadForm.set({
                method: "get",
                action: this.getServerHandlerMethodUrl(["Download", this.stateId, Ext.Array.map(r.parts, function (n) {
                    return StolenTech.Util.Path.getSafeFileNameForUrl(n)
                }).join("/"), StolenTech.Util.Path.getSafeFileNameForUrl(i)].join("/"))
            }), f = this.getServerHandlerMethodParameters({}), delete f.stateId, Ext.Object.each(f, function (n, t) {
                this.downloadForm.createChild({tag: "input", name: n, type: "hidden"}).dom.value = t
            }, this)) : (this.downloadForm.set({
                method: "get",
                action: this.getServerHandlerMethodUrl("Download/" + StolenTech.Util.Path.getSafeFileNameForUrl(i))
            }), o = this.getServerHandlerMethodParameters({
                path: r.fullPath,
                openInBrowser: !0,
                fileName: i
            }), Ext.Object.each(o, function (n, t) {
                this.downloadForm.createChild({tag: "input", name: n, type: "hidden"}).dom.value = t
            }, this)), Ext.is.iOS ? (this.downloadForm.set({target: "_blank"}), this.downloadForm.dom.submit()) : this.createChildWindow({
                childWindowId: "open-" + StolenTech.Util.Path.combine(r.fullPath, i, StolenTech.Util.Path.backSlash),
                title: i,
                items: {
                    xclass: "StolenTech.UI.IFrame",
                    style: {backgroundColor: "white"},
                    listeners: {
                        ready: function (n) {
                            var t = n.getFrame();
                            t.ownerComponent = this;
                            t.ownerChildWindow = n.ownerCt;
                            n.timeout = Ext.Function.defer(function () {
                                n.fireEvent("load", n)
                            }, 3e3);
                            this.downloadForm.set({target: t.name});
                            this.downloadForm.dom.submit()
                        }, load: function (n) {
                            clearTimeout(n.timeout);
                            var t = n.getFrameDocument();
                            !t || t.body && t.body.children.length || u === "xml" || n.ownerCt.close()
                        }, scope: this
                    }
                }
            }), !0
    ...
    downloadAsZip: function (n, t, i) {
        var r, u;
        if (!n.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Download)) return !1;
        if (!this.hasListener("downloading") || (r = this.fireEventEx("downloading", new StolenTech.UI.EventArgs({
            items: this.getEventItems(n, t),
            downloadFileName: StolenTech.Util.Path.getFileNameWithoutExtension(i.data.name) + ".zip",
            openInBrowser: !1
        })), r !== !1)) {
            while (this.downloadForm.dom.firstChild) this.downloadForm.dom.removeChild(this.downloadForm.dom.firstChild);
            return this.downloadForm.set({
            ...
            }), u = this.getServerHandlerMethodParameters({
                path: n.getPathData().fullPath,
                itemNames: "[json]" + Ext.encode(this.getItemNamesWithType(t)),
                zipFileName: StolenTech.Util.Path.getFileNameWithoutExtension(i.data.name) + ".zip"
            }), Ext.Object.each(u, function (n, t) {
                this.downloadForm.createChild({tag: "input", name: n, type: "hidden"}).dom.value = t
            }, this), this.downloadForm.dom.submit(), !0
        }
    },
    preview: function (n, t) {
        var i;
        if (!n.checkPermission(StolenTech.FileUltimate.FileManagerPermissionTypes.Preview)) return !1;
        var u = n.getPathData(), r = t.data.name, e = t.data.extension, o, f;
        if (this.excludedExtensionsForPreview[e.toLowerCase()]) return !1;
        if (this.getImageViewerType(e)) {
            if (this.hasListener("previewing") && (f = this.fireEventEx("previewing", new StolenTech.UI.EventArgs({
                item: this.getEventItems(n, [t])[0],
                previewerType: "ImageViewer"
            })), f === !1)) return;
            this.createChildWindow({
                childWindowId: "preview-" + StolenTech.Util.Path.combine(u.fullPath, r, StolenTech.Util.Path.backSlash),
                title: r + " - " + StolenTech.Util.Language.getEntry("Label.ImageViewer"),
                minWidth: 448,
                minHeight: 252,
                items: {
                    xclass: "StolenTech.UI.IFrame",
            ...
            i = this.createChildWindow({
                childWindowId: "preview-" + StolenTech.Util.Path.combine(u.fullPath, r, StolenTech.Util.Path.backSlash),
                title: r + " - " + StolenTech.Util.Language.getEntry("Label.MediaPlayer"),
                shrinkWrap: 3,
                width: undefined,
                height: undefined,
                items: new StolenTech.UI.MediaPlayer({
                    libraryPath: StolenTech.Util.Path.combine(this.resourceBasePath, "library/jwp"),
                    src: this.getServerHandlerMethodUrl("Preview/" + StolenTech.Util.Path.getSafeFileNameForUrl(r), {
                        path: u.fullPath,
                        fileName: r,
                        previewerType: "MediaPlayer"
                    }),
                    ...
                    isAudio: o.isAudio,
                    title: Ext.htmlEncode(r),
                    description: Ext.Array.map(this.centerPane.renderToolTipColumnFns, function (n) {
                        return n.columnText + ": " + n.renderer(t)
                    }).join("<br/>"),
                    listeners: {
                        scope: this, beforemediaresize: function () {
                            ...
                            i.center()
                        }, mediaformaterror: function (r) {
                            this.messageBox.showConfirm({
                                title: StolenTech.Util.Language.getEntry("Label.MediaFormatError"),
                                message: StolenTech.Util.Language.getEntry("Message.Error.MediaFormatError"),
                                detailsConfig: {data: r, type: "json"},
                                fn: function (r) {
                            ...
                            this.messageBox.showError({
                                title: StolenTech.Util.Language.getEntry("Label.MediaPlayer"),
                                message: n.message,
                                detailsConfig: {data: n, type: "json"}
                            })
                        }, error: function (n) {
                            this.messageBox.showError({
                                title: StolenTech.Util.Language.getEntry("Label.MediaPlayer"),
            ...
            this.createChildWindow({
                childWindowId: "preview-" + StolenTech.Util.Path.combine(u.fullPath, r, StolenTech.Util.Path.backSlash),
                title: r + " - " + StolenTech.Util.Language.getEntry("Label.DocumentViewer"),
                minWidth: 800,
                minHeight: 600,
                items: {
                    xclass: "StolenTech.UI.IFrame",
    ...
    getItemNameWithType: function (n) {
        return n.data.itemType == StolenTech.FileUltimate.FileManagerItemType.Folder ? n.data.name + "\\" : n.data.name
    },
    ...
    getEventFolder: function (n) {
        return (n = n || this.navigationSelection, !n) ? null : n.isRoot() ? {
            ...
            itemType: Ext.Object.getKey(StolenTech.FileUltimate.FileManagerItemType, n.data.itemType),
            name: n.data.name,
            fullPath: n.getPathData().fullPath
        }
    },
    getEventItems: function (n, t) {
        var f, u, r, i;
        for (n = n || this.navigationSelection, t = t || this.viewSelection, f = n.getPathData().fullPath, u = [], r = 0; r < t.length; r++) i = t[r], u.push({
            itemType: Ext.Object.getKey(StolenTech.FileUltimate.FileManagerItemType, i.data.itemType),
            name: i.data.name,
            fullPath: StolenTech.Util.Path.combine(f, i.data.name, StolenTech.Util.Path.backSlash),
    ...
    onCancelEvent: function (n) {
        n.cancelMessage && this.messageBox.showError({
            title: StolenTech.Util.Language.getEntry("Label.ActionCanceled"),
    ...
    onActionCut: function (n, t, i) {
        ...
        this.setClipboard(StolenTech.FileUltimate.FileManagerClipboardAction.Cut, r, u)
    },
    onActionCopy: function (n, t, i) {
        ...
        this.setClipboard(StolenTech.FileUltimate.FileManagerClipboardAction.Copy, r, u)
    },
    onActionPaste: function (n, t, i) {
        ...
        this.clipboard.action == StolenTech.FileUltimate.FileManagerClipboardAction.Cut && this.clearClipboard()
    },
    copyOrMove: function (n, t, i, r) {
        var f = !1, u, e;
        (n == StolenTech.FileUltimate.FileManagerClipboardAction.Cut && Ext.Array.each(r, function (n) {
            var i = t.findChildNodeByName(n.data.name);
            return i && (i == this.navigationSelection || i.contains(this.navigationSelection)) ? (f = !0, !1) : !0
        }, this), u = n === StolenTech.FileUltimate.FileManagerClipboardAction.Cut ? "moving" : "copying", this.hasListener(u) && (e = this.fireEventEx(u, new StolenTech.UI.EventArgs({
            items: this.getEventItems(t, r),
            targetFolder: this.getEventFolder(i)
        })), e === !1)) || this.callServerHandlerMethod({
            name: n == StolenTech.FileUltimate.FileManagerClipboardAction.Cut ? "Move" : "Copy",
            parameters: {
                path: t.getPathData().fullPath,
                itemNames: this.getItemNamesWithType(r),
                targetPath: i.getPathData().fullPath
            },
            callback: function (u, e) {
                var s, h, o;
                e || (s = n === StolenTech.FileUltimate.FileManagerClipboardAction.Cut ? "moved" : "copied", this.hasListener(s) && this.fireEventEx(s, new StolenTech.UI.EventArgs({
                    items: this.getEventItems(t, r),
                    targetFolder: this.getEventFolder(i)
                })), h = this, o = null, i != t && (o = function () {
                    i.parentNode && h.refreshFolderNode(i)
                }), f ? this.setNavigationSelection(t, o) : this.refreshFolderNode(t, o))
            },
            scope: this
        })
    },
    onActionDelete: function (n, t, i) {
        ...
        r.length === 1 ? (s = r[0], s.data.itemType === StolenTech.FileUltimate.FileManagerItemType.Folder ? (f = StolenTech.Util.Language.getEntry("Label.DeleteFolder"), e = StolenTech.Util.Language.getEntry("Message.Confirm.DeleteFolder")) : (f = StolenTech.Util.Language.getEntry("Label.DeleteFile"), e = StolenTech.Util.Language.getEntry("Message.Confirm.DeleteFile"))) : (f = StolenTech.Util.Language.getEntry("Label.DeleteMultipleItems"), e = StolenTech.Util.Language.getEntry("Message.Confirm.DeleteMultipleItems", r.length));
        this.messageBox.showConfirm({
            title: f,
            message: e,
            fn: function (n) {
                if (n === "yes") {
                    if (this.hasListener("deleting")) {
                        var t = this.fireEventEx("deleting", new StolenTech.UI.EventArgs({items: this.getEventItems(u, r)}));
                        if (t === !1) return
                    }
                    this.callServerHandlerMethod({
                        name: "Delete",
                        parameters: {path: u.getPathData().fullPath, itemNames: this.getItemNamesWithType(r)},
                        callback: function (n, t) {
                            t || (this.hasListener("deleted") && this.fireEventEx("deleted", new StolenTech.UI.EventArgs({items: this.getEventItems(u, r)})), o ? this.setNavigationSelection(u) : this.refreshFolderNode(u))
                        },
                        scope: this
                    })
                }
    ...
    onActionRename: function (n, t, i) {
        ...
        f = u.data.name;
        u.data.itemType == StolenTech.FileUltimate.FileManagerItemType.File ? (c = StolenTech.Util.Path.getExtension(f), o = StolenTech.Util.Path.getFileNameWithoutExtension(f), e = this.showFileExtensions ? f : o, s = !this.showFileExtensions, h = o.length) : (e = f, s = !1, h = f.length);
        this.messageBox.showPrompt({
            title: StolenTech.Util.Language.getEntry("Label.RenameItem"),
            message: StolenTech.Util.Language.getEntry("Message.Prompt.RenameItem"),
            fn: function (n, t) {
                var i, e;
                n == "ok" && ((i = t, s && (i += c), this.hasListener("renaming") && (e = this.fireEventEx("renaming", new StolenTech.UI.EventArgs({
                    item: this.getEventItems(r, [u])[0],
                    itemNewName: i
                })), e === !1)) || this.callServerHandlerMethod({
                    name: "Rename",
                    parameters: {path: r.getPathData().fullPath, itemName: this.getItemNameWithType(u), itemNewName: i},
                    callback: function (n, t) {
                        if (!t) {
                            this.hasListener("renamed") && this.fireEventEx("renamed", new StolenTech.UI.EventArgs({
                                item: this.getEventItems(r, [u])[0],
                                itemNewName: i
                            }));
            ...
            value: e,
            promptConfig: {
                selectionLength: h, validatorFn: function (n) {
                    return n == e || Ext.String.trim(n) == "" ? !1 : StolenTech.Util.Path.isValidFileName(n) ? !0 : StolenTech.Util.Language.getEntry("Message.Error.InvalidFileName") + '<br/>&emsp;&emsp;&emsp; \\ / : * ? " < > |'
                }
            }
        })
    },
    onActionNewFolder: function (n, t, i) {
        ...
        u = StolenTech.Util.Language.getEntry("Label.NewFolder");
        this.messageBox.showPrompt({
            title: StolenTech.Util.Language.getEntry("Label.CreateFolder"),
            message: StolenTech.Util.Language.getEntry("Message.Prompt.CreateFolder"),
            fn: function (n, t) {
                if (n == "ok") {
                    if (this.hasListener("creating")) {
                        var i = this.fireEventEx("creating", new StolenTech.UI.EventArgs({
                            itemName: t,
                            itemType: "Folder",
                    ...
                    this.callServerHandlerMethod({
                        name: "Create",
                        parameters: {path: r.getPathData().fullPath, itemName: this.getItemNameAsFolder(t)},
                        callback: function (n, i) {
                            i || (this.hasListener("created") && this.fireEventEx("created", new StolenTech.UI.EventArgs({
                                itemName: t,
                                itemType: "Folder",
                                targetFolder: this.getEventFolder(r)
                            })), this.refreshFolderNode(r))
            ...
            value: u,
            promptConfig: {
                selectionLength: u.length, validatorFn: function (n) {
                    return Ext.String.trim(n) == "" ? !1 : StolenTech.Util.Path.isValidFileName(n) ? !0 : StolenTech.Util.Language.getEntry("Message.Error.InvalidFileName") + '<br/>&emsp;&emsp;&emsp; \\ / : * ? " < > |'
                }
            }
        })
    },
    onActionDownload: function (n, t, i) {
        ...
        f.length > 1 || r.data.itemType === StolenTech.FileUltimate.FileManagerItemType.Folder ? this.downloadAsZip(u, f, r) : this.download(u, r)
    },
    onActionUpload: function (n, t, i, r) {
        ...
        switch (i) {
            ...
            case StolenTech.UI.ExplorerViewActionContext.View:
                ...
                break;
            case StolenTech.UI.ExplorerViewActionContext.ViewItem:
                f = this.navigationSelection.findChildNodeByName(this.contextMenuSelection.data.name);
                break;
            default:
                return
        }
        if (!this.fileUploader || this.fileUploader.isDestroyed) {
            this.fileUploader = StolenTech.UI.Loader.create(Ext.apply(this.fileUploaderConfig, {
                viewLayout: this.centerPane.viewLayout.name,
                viewCheckboxSelection: this.centerPane.checkboxSelection
            }));
            this.add(this.fileUploader.ownerCt);
            this.fileUploader.on({
                uploading: function (n, t) {
                    var i = n.fileManagerData;
                    if (this.hasListener("uploading")) return t.targetFolder = this.getEventFolder(i.folderNodeRecord), this.fireEventEx("uploading", t)
                }, uploaded: function (n, t) {
                    var f = n.fileManagerData, i, u, e, r, o;
                    ...
                    this.hasListener("uploaded") && (t.targetFolder = this.getEventFolder(f.folderNodeRecord), this.fireEventEx("uploaded", t))
                }, ready: function (n) {
                    ...
                    n.setCustomParameters({
                        ...
                        fileManagerPath: t.folderNodeRecord.getPathData().fullPath
                    });
                    t.readyCallback && t.readyCallback(n)
                }, scope: this
            })
        }
        this.fileUploader.multiView.setViewLayout(this.centerPane.viewLayout.name);
        this.fileUploader.multiView.setCheckboxSelection(this.centerPane.checkboxSelection);
        this.fileUploader.showFileExtensions = this.showFileExtensions;
        this.fileUploader.fileManagerData = {folderNodeRecord: f, readyCallback: r};
        this.fileUploader.ownerCt.setTitle(StolenTech.Util.Language.getEntry("Label.UploadFiles") + " - " + f.data.name);
        this.fileUploader.show();
        this.fileUploader.ownerCt.maximized || (u = this.fileUploader.ownerCt.getSize(), e = this.getChildWindowSize(), u.width = u.width >= e.width ? e.width : null, u.height = u.height >= e.height ? e.height : null, this.fileUploader.ownerCt.setSize(u), this.fileUploader.ownerCt.center())
    },
    ...
    onActionAddToZip: function (n, t, i) {
        ...
        s = ".zip";
        e = f.data.name;
        f.data.itemType == StolenTech.FileUltimate.FileManagerItemType.File ? (o = StolenTech.Util.Path.getFileNameWithoutExtension(e), h = this.showFileExtensions ? o + s : o, c = !this.showFileExtensions, l = o.length) : (h = e, c = !0, l = e.length);
        this.messageBox.showPrompt({
            title: StolenTech.Util.Language.getEntry("Label.AddItemsToZip"),
            message: StolenTech.Util.Language.getEntry("Message.Prompt.AddItemsToZip"),
            fn: function (n, t) {
                var i, f;
                n == "ok" && ((i = t, c && (i += s), this.hasListener("compressing") && (f = this.fireEventEx("compressing", new StolenTech.UI.EventArgs({
                    ...
                    callback: function (n, t) {
                        t || (this.hasListener("compressed") && this.fireEventEx("compressed", new StolenTech.UI.EventArgs({
                            items: this.getEventItems(r, u),
                            archiveFileName: i,
                            targetFolder: this.getEventFolder(r)
                        })), this.refreshFolderNode(r))
            ...
            value: h,
            promptConfig: {
                selectionLength: l, validatorFn: function (n) {
                    return Ext.String.trim(n) == "" ? !1 : StolenTech.Util.Path.isValidFileName(n) ? !0 : StolenTech.Util.Language.getEntry("Message.Error.InvalidFileName") + '<br/>&emsp;&emsp;&emsp; \\ / : * ? " < > |'
                }
            }
        })
    ...
    onActionExtractAllTo: function (n, t, i) {
        ...
        f = u.data.name;
        e = StolenTech.Util.Path.getFileNameWithoutExtension(f);
        this.messageBox.showPrompt({
            title: StolenTech.Util.Language.getEntry("Label.ExtractItemsFromArchive"),
            message: StolenTech.Util.Language.getEntry("Message.Prompt.ExtractItemsFromArchive"),
            fn: function (n, t) {
                var i, e;
                n == "ok" && ((i = r.getPathData().fullPath, this.hasListener("extracting") && (e = this.fireEventEx("extracting", new StolenTech.UI.EventArgs({
                    item: this.getEventItems(r, [u])[0],
                    targetFolder: this.getEventFolder(r),
                    targetSubfolderName: t
                })), e === !1)) || this.callServerHandlerMethod({
                    name: "ExtractAll",
                    parameters: {path: i, archiveFileName: f, targetPath: i, folderName: t},
                    callback: function (n, i) {
                        i || (this.hasListener("extracted") && this.fireEventEx("extracted", new StolenTech.UI.EventArgs({
                            item: this.getEventItems(r, [u])[0],
                            targetFolder: this.getEventFolder(r),
                            targetSubfolderName: t
                        })), this.refreshFolderNode(r))
            ...
            value: e,
            promptConfig: {
                selectionLength: e.length, validatorFn: function (n) {
                    return Ext.String.trim(n) == "" ? !1 : StolenTech.Util.Path.isValidFileName(n) ? !0 : StolenTech.Util.Language.getEntry("Message.Error.InvalidFileName") + '<br/>&emsp;&emsp;&emsp; \\ / : * ? " < > |'
                }
            }
        })
    ...
    onActionExtractAllHere: function (n, t, i) {
        ...
        (e = u.data.name, f = r.getPathData().fullPath, this.hasListener("extracting") && (o = this.fireEventEx("extracting", new StolenTech.UI.EventArgs({
            item: this.getEventItems(r, [u])[0],
            targetFolder: this.getEventFolder(r),
            targetSubfolderName: ""
        })), o === !1)) || this.callServerHandlerMethod({
            name: "ExtractAll",
            parameters: {path: f, archiveFileName: e, targetPath: f, folderName: ""},
            callback: function (n, t) {
                t || (this.hasListener("extracted") && this.fireEventEx("extracted", new StolenTech.UI.EventArgs({
                    item: this.getEventItems(r, [u])[0],
                    targetFolder: this.getEventFolder(r),
                    targetSubfolderName: ""
                })), this.refreshFolderNode(r))
    ...
    onActionChoose: function (n, t, i) {
        switch (i) {
            ...
            case StolenTech.UI.ExplorerViewActionContext.ViewItem:
                ...
                this.hasListener("chosen") && this.fireEventEx("chosen", new StolenTech.UI.EventArgs({
                    isCanceled: !1,
    ...
    onActionToggleFileExtensions: function (n) {
        this.showFileExtensions = n.checked;
        this.navigationPane && this.navigationPane.getView().refresh();
        this.centerPane && this.centerPane.refresh()
    }
});
Ext.define("StolenTech.FileUltimate.FolderItemModel", {
    extend: "Ext.data.Model",
    fields: [{name: "itemType"}, {
        name: "name",
        sortType: "asLocaleString"
    }, {name: "permissions"}, {name: "fileTypes"}, {
        name: "extension", calculate: function (n) {
            return n.itemType === StolenTech.FileUltimate.FileManagerItemType.File ? StolenTech.Util.Path.getExtension(n.name, !0) : ""
        }
    }],
    ...
    checkEitherPermissionName: function (n) {
        for (var i, r, t = 0; t < n.length; t++) if (i = n[t], r = StolenTech.FileUltimate.FileManagerPermissionTypes[i], this.checkPermission(r)) return !0;
        return !1
    },
...
Ext.define("StolenTech.FileUltimate.FolderNodeModel", {
    extend: "StolenTech.FileUltimate.FolderItemModel",
    fields: [{name: "expandable"}, {name: "hash"}],
    constructor: function () {
        this.callParent(arguments);
        this.nameIndexer = {};
        this.on({scope: this, append: this.onNodeAdded, insert: this.onNodeAdded, remove: this.onNodeRemove})
    },
    ...
    set: function () {
        var t = this.callParent(arguments), n = this;
    ...
    findChildNodeByPath: function (n) {
        for (var r, u = n.split(/[/\\]/g), t = this, i = 0; i < u.length; i++) if ((r = u[i], r.length !== 0) && (t = t.findChildNodeByName(r), !t)) return null;
        return t
    },
    getPathData: function () {
        for (var i = [], u = [], t = this, r, n; t.parentNode;) i.unshift(t.data.name), u.unshift(t.data.hash), t = t.parentNode;
        return r = StolenTech.Util.Path.backSlash, n = {}, n.parts = i, n.rootFolderName = i[0], n.rootFolderHash = u[0], n.relativePath = r + i.slice(1).join(r), n.fullPath = "[" + n.rootFolderName + "]:" + n.relativePath, n
    }
});
Ext.define("StolenTech.FileUltimate.FolderViewModel", {
    extend: "StolenTech.FileUltimate.FolderItemModel",
    fields: [{name: "size"}, {
        name: "type", sortType: "asLocaleString", calculate: function (n) {
            return n.systemType ? n.systemType : n.itemType === StolenTech.FileUltimate.FileManagerItemType.File ? n.extension ? StolenTech.Util.Language.getEntry("Label.FileType", n.extension.toUpperCase()) : StolenTech.Util.Language.getEntry("Label.File") : StolenTech.Util.Language.getEntry("Label.FolderType")
        }
    }, {name: "systemType"}, {name: "dateModified", type: "date", dateFormat: "c"}]
});
StolenTech.FileUltimate.FileManagerItemType = {RootFolder: 1, Folder: 2, File: 3};
StolenTech.FileUltimate.FileManagerPermissionTypes = {
    ListSubfolders: 1,
    ListFiles: 2,
    Create: 4,
    Delete: 8,
...
StolenTech.FileUltimate.FileManagerChooserType = {File: 1, Folder: 2, FileOrFolder: 3};
StolenTech.FileUltimate.FileManagerClipboardAction = {Copy: 1, Cut: 2};
StolenTech.FileUltimate.FileManagerDropAction = {Hidden: 1, NotAllowed: 2, CopyTo: 3, MoveTo: 4, UploadTo: 5};
typeof Crypto != "undefined" && Crypto.util || function () {
    var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = window.Crypto = {}, i = r.util = {
        rotl: function (n, t) {
            return n << t | n >>> 32 - t
        }, rotr: function (n, t) {
            return n << 32 - t | n >>> t
...
(function () {
    var i = Crypto, t = i.util, r = i.charenc, u = r.UTF8, f = r.Binary, n = i.MD5 = function (i, r) {
    ...
    n._md5 = function (i) {
        ...
        var h = t.bytesToWords(i), y = i.length * 8, r = 1732584193, f = -271733879, e = -1732584194, o = 271733878;
        for (s = 0; s < h.length; s++) h[s] = (h[s] << 8 | h[s] >>> 24) & 16711935 | (h[s] << 24 | h[s] >>> 8) & 4278255360;
        h[y >>> 5] |= 128 << y % 32;
        h[(y + 64 >>> 9 << 4) + 14] = y;
        var c = n._ff, l = n._gg, a = n._hh, v = n._ii;
...
(function (n, t) {
    ...
    (function (n, t) {
        ...
        i("moxie/core/utils/Basic", [], function () {
            function n(n) {
                var t;
                return n === t ? "undefined" : n === null ? "null" : n.nodeType ? "node" : {}.toString.call(n).match(/\s([a-z|A-Z]+)/)[1].toLowerCase()
            }
            ...
            function c(n, t) {
                function r() {
                    if (this.constructor = n, MXI_DEBUG) {
                        var t = function (n) {
                            var t = n.toString().match(/^function\s([^\(\s]+)/);
                            return t ? t[1] : !1
                        };
                        this.ctorName = t(n)
                    }
            ...
            function k(n) {
                return n ? String.prototype.trim ? String.prototype.trim.call(n) : n.toString().replace(/^\s*/, "").replace(/\s*$/, "") : n
            }

            function d(n) {
                if (typeof n != "string") return n;
                var i = {t: 1099511627776, g: 1073741824, m: 1048576, k: 1024}, t;
                return n = /^([0-9\.]+)([tmgk]?)$/.exec(n.toLowerCase().replace(/[^0-9\.tmkg]/g, "")), t = n[2], n = +n[1], i.hasOwnProperty(t) && (n *= i[t]), Math.floor(n)
            }
            ...
            var b = function () {
                var n = 0;
                return function (t) {
                    for (var r = (new Date).getTime().toString(32), i = 0; i < 5; i++) r += Math.floor(Math.random() * 65535).toString(32);
                    return (t || "o_") + r + (n++).toString(32)
                }
            }();
            return {
                guid: b,
        ...
        i("moxie/core/utils/Encode", [], function () {
            var t = function (n) {
                ...
                var u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", f, o, l, a, v, s, h, e,
                    r = 0, p = 0, c = "", y = [];
                if (!t) return t;
                t += "";
                ...
                var u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", s, h, c, l, a, v, y, r,
                    f = 0, w = 0, o = "", p = [];
                if (!n) return n;
            ...
            return {utf8_encode: t, utf8_decode: n, atob: i, btoa: r}
        });
        i("moxie/core/utils/Env", ["moxie/core/utils/Basic"], function (n) {
            function f(n, t, i) {
                var r = 0, f = 0, u = 0,
                    ...
                    e = function (n) {
                        return n = ("" + n).replace(/[_\-+]/g, "."), n = n.replace(/([^.\d]+)/g, ".$1.").replace(/\.{2,}/g, "."), n.length ? n.split(".") : [-8]
                    }, o = function (n) {
                        return n ? isNaN(n) ? s[n] || -7 : parseInt(n, 10) : 0
                    };
                for (n = e(n), t = e(t), f = Math.max(n.length, t.length), r = 0; r < f; r++) if (n[r] != t[r]) if (n[r] = o(n[r]), t[r] = o(t[r]), n[r] < t[r]) {
                    u = -1;
                    break
                } else if (n[r] > t[r]) {
                    u = 1;
            ...
            var u = function (n) {
                var c = "", o = "?", s = "function", l = "undefined", u = "object", t = "name", i = "version", h = {
                    has: function (n, t) {
                    ...
                    rgx: function () {
                        for (var r, h, y, f, t, c, i, v, o, e = 0, a = arguments; e < a.length; e += 2) {
                            ...
                            for (h = y = 0; h < v.length; h++) if (c = v[h].exec(this.getUA()), !!c) {
                        ...
                        var r, f;
                        for (r in i) if (typeof i[r] === u && i[r].length > 0) {
                            for (f = 0; f < i[r].length; f++) if (h.has(i[r][f], t)) return r === o ? n : r
                ...
                var r = {
                    access_global_ns: function () {
                        ...
                        var n = document.createElement("canvas"), t = !!(n.getContext && n.getContext("2d"));
                        ...
                        var i = document.createElement("canvas"), n = null, u;
                        try {
            ...
            return i.OS = i.os, MXI_DEBUG && (i.debug = {runtime: !0, events: !1}, i.log = function () {
                function r(n) {
                ...
                if (window && window.console && window.console.log && window.console.log.apply) window.console.log.apply(window.console, arguments); else if (document) {
                    if (t = document.getElementById("moxie-console"), t || (t = document.createElement("pre"), t.id = "moxie-console", document.body.appendChild(t)), i = arguments[0], n.typeOf(i) === "string") i = n.sprintf.apply(this, arguments); else if (n.inArray(n.typeOf(i), ["object", "array"]) !== -1) {
                        r(i);
                        return
                    }
        ...
        i("moxie/core/Exceptions", ["moxie/core/utils/Basic"], function (n) {
            ...
            return {
                RuntimeError: function () {
                    ...
                    var r = {NOT_INIT_ERR: 1, EXCEPTION_ERR: 3, NOT_SUPPORTED_ERR: 9, JS_ERR: 4};
                    ...
                    return n.extend(t, {NOT_ALLOWED_ERR: 1}), t.prototype = Error.prototype, t
                }(), ImageError: function () {
                    function i(n) {
                        this.code = n;
                        this.name = t(r, n);
                    ...
                    var r = {WRONG_FORMAT: 1, MAX_RESOLUTION_ERR: 2, INVALID_META_ERR: 3};
                    return n.extend(i, r), i.prototype = Error.prototype, i
                    ...
                    return n.extend(t, {UNSPECIFIED_EVENT_TYPE_ERR: 0}), t.prototype = Error.prototype, t
                }()
            }
        });
        i("moxie/core/utils/Dom", ["moxie/core/utils/Env"], function (n) {
            ...
            return {get: i, hasClass: t, addClass: r, removeClass: u, getStyle: f, getPos: e, getSize: o}
        });
        i("moxie/core/EventTarget", ["moxie/core/utils/Env", "moxie/core/Exceptions", "moxie/core/utils/Basic"], function (n, t, i) {
            ...
            return i.extend(u.prototype, {
                init: function () {
                    ...
                    e.push({fn: t, priority: u, scope: f || this});
                    ...
                    if (u = r[this.uid] && r[this.uid][n], u) {
                        if (t) {
                            for (f = u.length - 1; f >= 0; f--) if (u[f].fn === t) {
                                u.splice(f, 1);
                                break
                            }
                        } else u = [];
                    ...
                    var s, c, o, f, e = {}, l = !0, a, h;
                    if (i.typeOf(u) !== "string") if (f = u, i.typeOf(f.type) === "string") u = f.type, f.total !== a && f.loaded !== a && (e.total = f.total, e.loaded = f.loaded), e.async = f.async || !1; else throw new t.EventException(t.EventException.UNSPECIFIED_EVENT_TYPE_ERR);
        ...
        i("moxie/runtime/Runtime", ["moxie/core/utils/Env", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/EventTarget"], function (n, t, i, r) {
            function u(r, e, o, s, h) {
                var c = this, l, a = t.guid(e + "_"), v = h || "browser";
                r = r || {};
                f[a] = this;
                o = t.extend({
                    access_binary: !1,
                ...
                t.extend(this, {
                    ...
                    shimExec: function (n, t) {
                        ...
                        return c.getShim().exec.call(this, this.uid, n, t, i)
                    },
                    exec: function (n, t) {
                        var i = [].slice.call(arguments, 2);
            ...
            return u.order = "html5,flash,silverlight,html4", u.getRuntime = function (n) {
                ...
                var i, r = u.getConstructor(n), f;
                return r ? (i = new r({required_caps: t}), f = i.mode, i.destroy(), !!f) : !1
            }, u.thatCan = function (n, t) {
                var i = (t || u.order).split(/\s*,\s*/);
                for (var r in i) if (u.can(i[r], n)) return i[r];
                return null
                ...
                i.extend(this, {
                    connectRuntime: function (f) {
                        function s(i) {
                            ...
                            if (o = i.shift().toLowerCase(), h = r.getConstructor(o), !h) {
                        ...
                        s((f.runtime_order || r.order).split(/\s*,\s*/))
        ...
        i("moxie/file/Blob", ["moxie/core/utils/Basic", "moxie/core/utils/Encode", "moxie/runtime/RuntimeClient"], function (n, t, i) {
            function u(f, e) {
                ...
                e ? n.typeOf(e) === "string" && (e = {data: e}) : e = {};
                n.extend(this, {
                    ...
                    slice: function (n, t, i) {
                        return this.isDetached() ? o.apply(this, arguments) : this.getRuntime().exec.call(this, "Blob", "slice", this.getSource(), n, t, i)
                    },
                    getSource: function () {
                        return r[this.uid] ? r[this.uid] : null
                    },
                    detach: function (n) {
                        if (this.ruid && (this.getRuntime().exec.call(this, "Blob", "destroy"), this.disconnectRuntime(), this.ruid = null), n = n || "", n.substr(0, 5) == "data:") {
        ...
        i("moxie/core/utils/Mime", ["moxie/core/utils/Basic", "moxie/core/I18n"], function (n, t) {
            var r = {}, i = {}, u = function (n) {
                ...
                for (var u, r, f, e = [], o = 0; o < t.length; o++) for (u = t[o].extensions.toLowerCase().split(/\s*,\s*/), r = 0; r < u.length; r++) {
                    if (u[r] === "*") return [];
                    if (f = e[u[r]], i && /^\w+$/.test(u[r])) e.push("." + u[r]); else if (f && n.inArray(f, e) === -1) e.push(f); else if (!f) return []
                }
                return e
            }, f = function (t) {
                var r = [];
                return n.each(t, function (t) {
                    ...
                    u && (u[2] === "*" ? n.each(i, function (n, t) {
                        new RegExp("^" + u[1] + "/").test(t) && [].push.apply(r, i[t])
                    }) : i[t] && [].push.apply(r, i[t]))
                }), r
            }, s = function (i) {
                var u = [], r = [];
                return n.typeOf(i) === "string" && (i = n.trim(i).split(/\s*,\s*/)), r = f(i), u.push({
        ...
        i("moxie/file/FileInput", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Mime", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/core/I18n", "moxie/runtime/Runtime", "moxie/runtime/RuntimeClient"], function (n, t, i, r, u, f, e, o, s) {
            function h(f) {
                ...
                var h, l, a;
                if (n.inArray(n.typeOf(f), ["string", "node"]) !== -1 && (f = {browse_button: f}), l = r.get(f.browse_button), !l) throw new u.DOMException(u.DOMException.NOT_FOUND_ERR);
                a = {
                ...
                s.call(this);
                n.extend(this, {
                    uid: n.guid("uid_"), ruid: null, shimid: null, files: null, init: function () {
                        var t = this;
                        ...
                        t.connectRuntime(n.extend({}, f, {required_caps: {select_file: !0}}))
        ...
        i("moxie/file/File", ["moxie/core/utils/Basic", "moxie/core/utils/Mime", "moxie/file/Blob"], function (n, t, i) {
            function r(r, u) {
                ...
                n.extend(this, {
                    name: f || n.guid("file_"),
                    relativePath: "",
                    lastModifiedDate: u.lastModifiedDate || (new Date).toLocaleString()
                })
            }
        ...
        i("moxie/file/FileDrop", ["moxie/core/I18n", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/file/File", "moxie/runtime/RuntimeClient", "moxie/core/EventTarget", "moxie/core/utils/Mime"], function (n, t, i, r, u, f, e, o, s) {
            function h(i) {
                ...
                var f = this, o;
                typeof i == "string" && (i = {drop_zone: i});
                o = {accept: [{title: n.translate("All Files"), extensions: "*"}], required_caps: {drag_and_drop: !0}};
                ...
                e.call(f);
                r.extend(f, {
                    uid: r.guid("uid_"), ruid: null, files: null, init: function () {
        ...
        i("moxie/core/utils/Url", ["moxie/core/utils/Basic"], function (n) {
            ...
            return {parseUrl: t, resolveUrl: i, hasSameOrigin: r}
        });
        ...
        i("moxie/file/FileReaderSync", ["moxie/core/utils/Basic", "moxie/runtime/RuntimeClient", "moxie/core/utils/Encode"], function (n, t, i) {
            return function () {
                function r(n, t) {
                    ...
                    } else return o = this.connectRuntime(t.ruid).exec.call(this, "FileReaderSync", "read", n, t), this.disconnectRuntime(), o
                }

                t.call(this);
                n.extend(this, {
                    uid: n.guid("uid_"), readAsBinaryString: function (n) {
        ...
        i("moxie/xhr/FormData", ["moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/file/Blob"], function (n, t, i) {
            function r() {
                ...
                t.extend(this, {
                    append: function (u, f) {
                        var o = this, e = t.typeOf(f);
                        f instanceof i ? n = {name: u, value: f} : "array" === e ? (u += "[]", t.each(f, function (n) {
                            o.append(u, n)
        ...
        i("moxie/xhr/XMLHttpRequest", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/core/utils/Encode", "moxie/core/utils/Url", "moxie/runtime/Runtime", "moxie/runtime/RuntimeTarget", "moxie/file/Blob", "moxie/file/FileReaderSync", "moxie/xhr/FormData", "moxie/core/utils/Env", "moxie/core/utils/Mime"], function (n, t, i, r, u, f, e, o, s, h, c, l) {
            ...
            function a() {
                ...
                function kt(t) {
                    ...
                    w.required_caps = n.extend({}, w.required_caps, {return_response_type: r.responseType});
                ...
                var ht = this, tt = {
                        ...
                        responseText: null,
                        response: null
                    }, it = !0, ct, st, b = {}, lt, at, vt = null, rt = null, ut = !1, d = !1, ft = !1, et = !1, g = !1,
                    ot = !1, yt, pt, wt = null, bt = null, w = {}, s, nt = "", k;
                n.extend(this, tt, {
                    uid: n.guid("uid_"), upload: new v, open: function (f, e, o, s, h) {
                        var c;
                        ...
                        return (u = n.trim(u).toLowerCase(), !!~n.inArray(u, ["accept-charset", "accept-encoding", "access-control-request-headers", "access-control-request-method", "connection", "content-length", "cookie", "cookie2", "content-transfer-encoding", "date", "expect", "host", "keep-alive", "origin", "referer", "te", "trailer", "transfer-encoding", "upgrade", "user-agent", "via"]) || /^(proxy\-|sec\-)/.test(u)) ? !1 : (b[u] ? b[u] += ", " + f : b[u] = f, !0)
                        ...
                        if (w = n.typeOf(u) === "string" ? {ruid: u} : u ? u : {}, this.readyState !== a.OPENED || d) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
                        if (i instanceof o) w.ruid = i.ruid, rt = i.type || "application/octet-stream"; else if (i instanceof h) {
                            if (i.hasBlob()) {
                                var f = i.getBlob();
                                w.ruid = f.ruid;
                        ...
                        if (g = !0, ut = !1, ~n.inArray(i("readyState"), [a.UNSENT, a.OPENED, a.DONE])) i("readyState", a.UNSENT); else {
                            if (i("readyState", a.DONE), d = !1, s) s.getRuntime().exec.call(s, "XMLHttpRequest", "abort", et); else throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
                            et = !0
                        }
                    }, destroy: function () {
        ...
        i("moxie/runtime/Transporter", ["moxie/core/utils/Basic", "moxie/core/utils/Encode", "moxie/runtime/RuntimeClient", "moxie/core/EventTarget"], function (n, t, i, r) {
            function u() {
                ...
                i.call(this);
                n.extend(this, {
                    uid: n.guid("uid_"), state: u.IDLE, result: null, transport: function (t, i, r) {
                        var u = this, e;
                        r = n.extend({chunk_size: 204798}, r);
            ...
            function v() {
                ...
                function r(t) {
                    ...
                    try {
                        ...
                        } else if (n.inArray(u, ["blob", "file"]) !== -1) r.call(this, new l(null, t), arguments[1]); else if (u === "string") t.substr(0, 5) === "data:" ? r.call(this, new c(null, {data: t}), arguments[1]) : b.apply(this, arguments); else if (u === "node" && t.nodeName.toLowerCase() === "img") r.call(this, t.src, arguments[1]); else throw new i.DOMException(i.DOMException.TYPE_MISMATCH_ERR);
                    } catch (f) {
                ...
                n.extend(this, {
                    ...
                    resize: function (t) {
                        var u = this, o, e, r = {x: 0, y: 0, width: u.width, height: u.height}, f = n.extendIf({
                            width: u.width,
                            height: u.height,
                        ...
                        try {
                            ...
                            if (o = u.meta && u.meta.tiff && u.meta.tiff.Orientation || 1, n.inArray(o, [5, 6, 7, 8]) !== -1 && (s = f.width, f.width = f.height, f.height = s), f.crop) {
                                ...
                                switch (f.crop.toLowerCase().replace(/_/, "-")) {
                                    case"rb":
                                    case"right-bottom":
                                        r.x = u.width - r.width;
                        ...
                        function l(t, u) {
                            ...
                            s.can("use_data_uri_of", h.length) ? (r.innerHTML = '<img src="' + h + '" width="' + f.width + '" height="' + f.height + '" alt="" />', f.destroy(), e.trigger("embedded")) : (v = new o, v.bind("TransportingComplete", function () {
                                ...
                                e.bind("Embedded", function () {
                                    n.extend(c.getShimContainer().style, {
                                        top: "0px",
                                        left: "0px",
                                        width: f.width + "px",
                                        height: f.height + "px"
        ...
        i("moxie/runtime/html5/Runtime", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/Runtime", "moxie/core/utils/Env"], function (n, t, i, r) {
            function o(t) {
                var o = this, s = i.capTest, h = i.capTrue, c = n.extend({
                    ...
                    summon_file_dialog: function () {
                        return o.can("select_file") && !(r.browser === "Firefox" && r.verComp(r.version, 4, "<") || r.browser === "Opera" && r.verComp(r.version, 12, "<") || r.browser === "IE" && r.verComp(r.version, 10, "<") || r.os === "iOS" || c.isIOSDesktopMode() || r.os === "Android" || c.isAndroidDesktopMode())
                    },
                    isIOSDesktopMode: function () {
                        return navigator.vendor.indexOf("Apple") === 0 && "ontouchstart" in document.body
                    },
                    isAndroidDesktopMode: function () {
                        return navigator.platform.indexOf("Linux a") === 0 && "ontouchstart" in document.body
                    },
                    upload_filesize: h,
                    use_http_method: h
                }, arguments[2]);
        ...
        i("moxie/runtime/html5/file/Blob", ["moxie/runtime/html5/Runtime", "moxie/file/Blob"], function (n, t) {
            function i() {
                ...
                this.slice = function () {
                    return new t(this.getRuntime().uid, n.apply(this, arguments))
                };
                this.destroy = function () {
        ...
        i("moxie/core/utils/Events", ["moxie/core/utils/Basic"], function (n) {
            ...
            var i = {}, t = "moxie_" + n.guid(), e = function (r, e, o, s) {
                var h, c;
                e = e.toLowerCase();
                ...
                c[e].push({func: h, orig: o, key: s})
            }, r = function (r, u, f) {
                var e, s, o;
                if (u = u.toLowerCase(), r[t] && i[r[t]] && i[r[t]][u]) e = i[r[t]][u]; else return;
                for (o = e.length - 1; o >= 0; o--) if ((e[o].orig === f || e[o].key === f) && (r.removeEventListener ? r.removeEventListener(u, e[o].func, !1) : r.detachEvent && r.detachEvent("on" + u, e[o].func), e[o].orig = null, e[o].func = null, e.splice(o, 1), f !== s)) break;
            ...
            return {addEvent: e, removeEvent: r, removeAllEvents: o}
        });
        i("moxie/runtime/html5/file/FileInput", ["moxie/runtime/html5/Runtime", "moxie/file/File", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Events", "moxie/core/utils/Mime", "moxie/core/utils/Env"], function (n, t, i, r, u, f, e) {
            function o() {
                ...
                i.extend(this, {
                    init: function (s) {
                        var h = this, c = h.getRuntime(), a, v, p, l, w, y;
                        n = s;
                        ...
                        a = r.get(c.uid);
                        i.extend(a.style, {position: "absolute", top: 0, left: 0, width: "100%", height: "100%"});
                        ...
                        c.can("summon_file_dialog") && (r.getStyle(l, "position") === "static" && (l.style.position = "relative"), u.addEvent(l, "click", function (n) {
                            ...
                            w = parseInt(o, 10) || 1;
                            r.get(n.browse_button).style.zIndex = w;
                            this.getRuntime().getShimContainer().style.zIndex = w - 1
                        }));
                        ...
                        (c.can("summon_file_dialog") ? a : l).setAttribute("tabindex", -1);
                        a.onchange = function b() {
                            if (h.files = [], i.each(this.files, function (i) {
                                ...
                                i.relativePath = r;
                                h.files.push(i)
                            }), e.browser !== "IE" && e.browser !== "IEMobile") this.value = ""; else {
                        ...
                        h.trigger({type: "ready", async: !0});
                        v = null
                    }, setOption: function (n, t) {
                        var u = this.getRuntime(), i = r.get(u.uid), e;
                        switch (n) {
                            case"accept":
                        ...
                        var i = this.getRuntime(), t;
                        (t = r.get(i.uid)) && (t.disabled = !!n)
                    }, destroy: function () {
                        var e = this.getRuntime(), s = e.getShim(), t = e.getShimContainer(),
                            f = n && r.get(n.container), i = n && r.get(n.browse_button);
        ...
        i("moxie/runtime/html5/xhr/XMLHttpRequest", ["moxie/runtime/html5/Runtime", "moxie/core/utils/Basic", "moxie/core/utils/Mime", "moxie/core/utils/Url", "moxie/file/File", "moxie/file/Blob", "moxie/xhr/FormData", "moxie/core/Exceptions", "moxie/core/utils/Env"], function (n, t, i, r, u, f, e, o, s) {
            function h() {
                function l(n, t) {
                    var u = this, r, i;
                    r = t.getBlob().getSource();
                    i = new window.FileReader;
                    i.onload = function () {
                        t.append(t.getBlobName(), new f(null, {type: r.type, data: i.result}));
                        c.send.call(u, n, t)
                    };
                ...
                function v(n) {
                    var t = n.responseXML, i = n.responseText;
                ...
                function y(t) {
                    var r = "----moxieboundary" + (new Date).getTime(), u = "--", i = "\r\n", e = "",
                        s = this.getRuntime();
                ...
                t.extend(this, {
                    send: function (i, u) {
                        var o = this,
                            ...
                            w = s.browser === "Android Browser", v = !1, c;
                        if (h = i.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), n = a(), n.open(i.method, i.url, i.async, i.user, i.password), u instanceof f) u.isDetached() && (v = !0), u = u.getSource(); else if (u instanceof e) {
                            if (u.hasBlob()) if (u.getBlob().isDetached()) u = y.call(o, u), v = !0; else if ((p || w) && t.typeOf(u.getBlob().getSource()) === "blob" && window.FileReader) {
                                l.call(o, i, u);
                                return
                            }
                        ...
                        n.upload ? (i.withCredentials && (n.withCredentials = !0), n.addEventListener("load", function (n) {
                            ...
                            o.trigger({type: "UploadProgress", loaded: n.loaded, total: n.total})
                        ...
                        c = h = null;
                        var n = this.getRuntime();
                        n && n.getShim().removeInstance(this.uid)
                    }
                })
            }
        ...
        i("moxie/runtime/html5/utils/BinaryReader", ["moxie/core/utils/Basic"], function (n) {
            ...
            return n.extend(t.prototype, {
                littleEndian: !1, read: function (n, t) {
                    var r, u, i;
                    ...
                    return this.asArray("CHAR", n, t).join("")
            ...
            return function i(r) {
                ...
                return o.clear(), {
                    headers: u, restore: function (t) {
                        ...
                        var r = [], i, f, e;
                        for (typeof t == "string" ? r.push(t) : r = t, i = f = 0, e = u.length; i < e; i++) if (u[i].name === n.toUpperCase() && (u[i].segment = r[f], u[i].length = r[f].length, f++), f >= r.length) break
                    }, purge: function () {
                        this.headers = u = []
                    }
                }
            ...
            function u(f) {
                function l(i, u) {
                    for (var o = this, s, a, c, v, f, y, p = [], w = {}, k = {
                        ...
                        SLONG: 4,
                        SRATIONAL: 8
                    }, b = o.SHORT(i), l = 0; l < b; l++) if (p = [], f = i + 2 + l * 12, s = u[o.SHORT(f)], s !== t) {
                        ...
                        if (a === "ASCII") {
                            w[s] = n.trim(o.STRING(f, c).replace(/\0$/, ""));
                            continue
                ...
                function y(n, t, i) {
                    ...
                    for (u = e[n.toLowerCase() + "IFD"], l = this.SHORT(u), r = 0; r < l; r++) if (f = u + 12 * r + 2, this.SHORT(f) == t) {
                        o = f + 8;
                        break
                    }
                    if (!o) return !1;
                ...
                }, e = {tiffHeader: 10}, c = e.tiffHeader, a = {clear: this.clear}, n.extend(this, {
                    read: function () {
                        try {
                ...
                }), this.SHORT(0) !== 65505 || this.STRING(4, 5).toUpperCase() !== "EXIF\0") throw new r.ImageError(r.ImageError.INVALID_META_ERR);
        ...
        i("moxie/runtime/html5/image/JPEG", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/html5/image/JPEGHeaders", "moxie/runtime/html5/utils/BinaryReader", "moxie/runtime/html5/image/ExifParser"], function (n, t, i, r, u) {
            function f(f) {
                ...
                e && (this.meta = {tiff: e.TIFF(), exif: e.EXIF(), gps: e.GPS(), thumb: l()})
            }
        ...
        i("moxie/runtime/html5/image/PNG", ["moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/runtime/html5/utils/BinaryReader"], function (n, t, i) {
            function r(r) {
                ...
                var u, o, s, f;
                u = new i(r), function () {
                    for (var i = 0, t = 0, r = [35152, 20039, 3338, 6666], t = 0; t < r.length; t++, i += 2) if (r[t] != u.SHORT(i)) throw new n.ImageError(n.ImageError.WRONG_FORMAT);
                }();
                f = h.call(this);
                t.extend(this, {
                    type: "image/png",
        ...
        i("moxie/runtime/html5/image/ResizerCanvas", [], function () {
            function n(i, r, u) {
                var e = i.width > i.height ? "width" : "height", s = Math.round(i[e] * r), o = !1, f;
                return u !== "nearest" && (r < .5 || r > 2) && (r = r < .5 ? .5 : 2, o = !0), f = t(i, r), o ? n(f, s / f[e], u) : f
            }

            function t(n, t) {
                var r = n.width, u = n.height, f = Math.round(r * t), e = Math.round(u * t),
                    i = document.createElement("canvas");
                return i.width = f, i.height = e, i.getContext("2d").drawImage(n, 0, 0, r, u, 0, 0, f, e), n = null, i
            }
        ...
        i("moxie/runtime/html5/image/Image", ["moxie/runtime/html5/Runtime", "moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/core/utils/Encode", "moxie/file/Blob", "moxie/file/File", "moxie/runtime/html5/image/ImageInfo", "moxie/runtime/html5/image/ResizerCanvas", "moxie/core/utils/Mime", "moxie/core/utils/Env"], function (n, t, i, r, u, f, e, o, s) {
            function h() {
                ...
                function k() {
                    var t = w();
                    return t.nodeName.toLowerCase() == "canvas" ? t : (n = document.createElement("canvas"), n.width = t.width, n.height = t.height, n.getContext("2d").drawImage(t, 0, 0), n)
                }
                ...
                function tt(n, t) {
                    ...
                    }, r.readAsDataURL(n); else return t.call(this, n.getAsDataURL())
                }

                function it(n, i) {
                    var o = Math.PI / 180, e = document.createElement("canvas"), r = e.getContext("2d"), u = n.width,
                        f = n.height;
                ...
                var y = this, a, c, n, h, l, v = !1, p = !0;
                t.extend(this, {
                    loadFromBlob: function (n) {
                        var t = this.getRuntime(), r = arguments.length > 1 ? arguments[1] : !0;
                        ...
                        this.meta = n.meta;
                        l = new f(null, {name: n.name, size: n.size, type: n.type});
                        ...
                        var u = document.createElement("canvas"), f;
                        u.width = t.width;
                        u.height = t.height;
                        u.getContext("2d").drawImage(w(), t.x, t.y, t.width, t.height, 0, 0, u.width, u.height);
                        n = o.scale(u, i);
                        p = r.preserveHeaders;
                        ...
                        })) : new f(null, {name: l.name || "", type: n, data: y.getAsBinaryString(n, t)})
                        ...
                        if ("image/jpeg" !== t) h = b(y.getAsDataURL(t, i)); else {
                            var r;
                            i || (i = 90);
                            k();
                            try {
        ...
        i("moxie/runtime/flash/Runtime", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/runtime/Runtime"], function (n, t, i, r, f) {
            ...
            function l(c) {
                var l = this, a;
                c = n.extend({swf_url: t.swf_url}, c);
                f.call(this, c, e, {
                ...
                n.extend(this, {
                    getShim: function () {
                        ...
                        var i = [].slice.call(arguments, 2);
                        return l.getShim().exec(this.uid, n, t, i)
                    }, init: function () {
                        var i, e, u;
        ...
        i("moxie/runtime/flash/file/FileInput", ["moxie/runtime/flash/Runtime", "moxie/file/File", "moxie/core/utils/Dom", "moxie/core/utils/Basic"], function (n, t, i, r) {
            var u = {
                init: function (n) {
                    var u = this, e = this.getRuntime(), f = i.get(n.browse_button);
        ...
        i("moxie/runtime/flash/runtime/Transporter", ["moxie/runtime/flash/Runtime", "moxie/file/Blob"], function (n, t) {
            var i = {
                getAsBlob: function (n) {
                    var i = this.getRuntime(), r = i.shimExec.call(this, "Transporter", "getAsBlob", n);
            ...
            var s = {
                send: function (n, r) {
                    ...
                    function a(n, t) {
                        ...
                        i.transport(n.getSource(), n.type, {ruid: u.uid})
                    }

                    var f = this, u = f.getRuntime(), c, h;
        ...
        i("moxie/runtime/flash/image/Image", ["moxie/runtime/flash/Runtime", "moxie/core/utils/Basic", "moxie/runtime/Transporter", "moxie/file/Blob", "moxie/file/FileReaderSync"], function (n, t, i, r, u) {
            var f = {
                loadFromBlob: function (n) {
                    ...
                    var r = this.getRuntime(), n = r.Image.getAsBlob.apply(this, arguments), t, i;
        ...
        i("moxie/runtime/silverlight/Runtime", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/runtime/Runtime"], function (n, t, i, r, f) {
            function s(n) {
                var r = !1, o = null, u, t, i, f, s, e = 0, h;
                try {
                    try {
            ...
            function h(h) {
                var c = this, l;
                h = n.extend({xap_url: t.xap_url}, h);
                f.call(this, h, e, {
                ...
                n.extend(this, {
                    getShim: function () {
                        ...
                        var i = [].slice.call(arguments, 2);
                        return c.getShim().exec(this.uid, n, t, i)
                    }, init: function () {
                        var n;
        ...
        i("moxie/runtime/silverlight/file/FileInput", ["moxie/runtime/silverlight/Runtime", "moxie/file/File", "moxie/core/utils/Dom", "moxie/core/utils/Basic"], function (n, t, i, r) {
            ...
            var f = {
                init: function (n) {
                    var f = this, e = this.getRuntime(), o = i.get(n.browse_button);
                    ...
                    n == "accept" && (t = u(t));
                    this.getRuntime().shimExec.call(this, "FileInput", "setOption", n, t)
                }
            };
            ...
            var r = {
                init: function () {
                    ...
                    return u = r.getShimContainer(), i.addEvent(u, "dragover", function (n) {
                        ...
                        n.preventDefault();
                        var i = t.get(r.uid).dragEnter(n);
                        i && n.stopPropagation()
                    }, n.uid), i.addEvent(u, "drop", function (n) {
                        n.preventDefault();
                        var i = t.get(r.uid).dragDrop(n);
                        i && n.stopPropagation()
        ...
        i("moxie/runtime/silverlight/image/Image", ["moxie/runtime/silverlight/Runtime", "moxie/core/utils/Basic", "moxie/file/Blob", "moxie/runtime/flash/image/Image"], function (n, t, i, r) {
            return n.Image = t.extend({}, r, {
                getInfo: function () {
                    var u = this.getRuntime(), n = {meta: {}}, r = u.shimExec.call(this, "Image", "getInfo");
                    return r.meta && (t.each(["tiff", "exif", "gps", "thumb"], function (t) {
                        var u = r.meta[t], e, f, o, i;
                        if (u && u.keys) for (n.meta[t] = {}, f = 0, o = u.keys.length; f < o; f++) e = u.keys[f], i = u[e], i && (/^(\d|[1-9]\d+)$/.test(i) ? i = parseInt(i, 10) : /^\d*\.\d+$/.test(i) && (i = parseFloat(i)), n.meta[t][e] = i)
                    ...
                    this.getRuntime().shimExec.call(this, "Image", "resize", n.x, n.y, n.width, n.height, t, i.preserveHeaders, i.resample)
                }
            })
        });
        i("moxie/runtime/html4/Runtime", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/runtime/Runtime", "moxie/core/utils/Env"], function (n, t, i, r) {
            function o(t) {
                var o = this, s = i.capTest, h = i.capTrue;
                i.call(this, t, e, {
        ...
        i("moxie/runtime/html4/file/FileInput", ["moxie/runtime/html4/Runtime", "moxie/file/File", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Events", "moxie/core/utils/Mime", "moxie/core/utils/Env"], function (n, t, i, r, u, f, e) {
            function o() {
                function c() {
                    var l = this, v = l.getRuntime(), w, y, a, h, f, p;
                    p = i.guid("uid_");
                    w = v.getShimContainer();
                    o && (a = r.get(o + "_form"), a && (i.extend(a.style, {top: "100%"}), a.firstChild.setAttribute("tabindex", -1)));
                    ...
                    i.extend(f.style, {fontSize: "999px", opacity: 0});
                    h.appendChild(f);
                    w.appendChild(h);
                    i.extend(f.style, {position: "absolute", top: 0, left: 0, width: "100%", height: "100%"});
                    e.browser === "IE" && e.verComp(e.version, 10, "<") && i.extend(f.style, {filter: "progid:DXImageTransform.Microsoft.Alpha(opacity=0)"});
                    f.onchange = function () {
                        var n;
                        this.value && (n = this.files ? this.files[0] : {name: this.value}, n = new t(v.uid, n), this.onchange = function () {
                        }, c.call(l), l.files = [n], f.setAttribute("id", n.uid), h.setAttribute("id", n.uid + "_form"), l.trigger("change"), f = h = null)
                    };
                ...
                i.extend(this, {
                    init: function (t) {
                        var i = this, e = i.getRuntime(), o;
                        n = t;
                        s = f.extList2mimes(t.accept, e.can("filter_by_extension"));
                        o = e.getShimContainer(), function () {
                            var f, c, s;
                            ...
                            e.can("summon_file_dialog") ? (r.getStyle(f, "position") === "static" && (f.style.position = "relative"), i.bind("Refresh", function () {
                                c = parseInt(h, 10) || 1;
                                r.get(n.browse_button).style.zIndex = c;
                                this.getRuntime().getShimContainer().style.zIndex = c - 1
                        ...
                        c.call(this);
                        o = null;
                        i.trigger({type: "ready", async: !0})
                    }, setOption: function (n, t) {
                        var u = this.getRuntime(), i;
                        ...
                        var e = this.getRuntime(), c = e.getShim(), t = e.getShimContainer(),
                            f = n && r.get(n.container), i = n && r.get(n.browse_button);
                        f && u.removeAllEvents(f, this.uid);
        ...
        i("moxie/runtime/html4/xhr/XMLHttpRequest", ["moxie/runtime/html4/Runtime", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Url", "moxie/core/Exceptions", "moxie/core/utils/Events", "moxie/file/Blob", "moxie/xhr/FormData"], function (n, t, i, r, u, f, e, o) {
            function s() {
                function c(t) {
                    ...
                    if (n) {
                        ...
                        setTimeout(function () {
                            ...
                            var i = o.getRuntime().getShimContainer();
                ...
                t.extend(this, {
                    send: function (l, a) {
                        function d() {
                            var u = k.getShimContainer() || document.body, i = document.createElement("div");
                            ...
                            f.addEvent(n, "load", function () {
                                ...
                                try {
                                    ...
                                    f = i.title.match(/The resource cannot be found/);
                                    u ? (h = +u[0], s = i.documentElement.innerHTML) : f ? (h = 404, s = i.documentElement.innerHTML) : (h = 200, s = t.trim(i.body.innerHTML), y.trigger({
                                        type: "progress",
                                        loaded: s.length,
                                        total: s.length
                                    }), b && y.trigger({
                                    ...
                                    if (r.hasSameOrigin(l.url)) h = 404; else {
                                        c.call(y, function () {
                                            y.trigger("error")
                                        });
                                        return
                        ...
                        var y = this, k = y.getRuntime(), p, v, w, b;
                        ...
                        } else p = t.guid("uid_"), v = document.createElement("form"), v.setAttribute("id", p + "_form"), v.setAttribute("method", l.method), v.setAttribute("enctype", "multipart/form-data"), v.setAttribute("encoding", "multipart/form-data"), k.getShimContainer().appendChild(v);
                        v.setAttribute("target", p + "_iframe");
                        a instanceof o && a.each(function (n, i) {
                            if (n instanceof e) w && w.setAttribute("name", i); else {
                                var r = document.createElement("input");
                                t.extend(r, {type: "hidden", name: i, value: n});
                        ...
                        if ("json" === n) {
                            if (t.typeOf(s) === "string" && !!window.JSON) try {
                                return JSON.parse(s.replace(/^\s*<pre[^>]*>/, "").replace(/<\/pre>\s*$/, ""))
                            } catch (i) {
                                return null
                            }
                        } else "document" === n;
...
(function (n, t) {
    ...
    (function (n, t, i) {
        ...
        var e = window.setTimeout, o = {}, u = t.core.utils, f = t.runtime.Runtime, r = {
            VERSION: "2.3.6",
            STOPPED: 1,
            STARTED: 2,
            QUEUED: 1,
            ...
            predictRuntime: function (n, t) {
                var i, u;
                return i = new r.Uploader(n), u = f.thatCan(i.getOption().required_features, t || n.runtimes), i.destroy(), u
            },
        ...
        r.addFileFilter("prevent_duplicates", function (n, t, i) {
            if (n) for (var u = this.files.length; u--;) if (t.name === this.files[u].name && t.size === this.files[u].size) {
                this.trigger("Error", {
        ...
        r.Uploader = function (n) {
            ...
            function tt(n, i) {
                ...
                n.drop_element && r.each(n.drop_element, function (n) {
                    o.push(function (i) {
                        var o = new t.file.FileDrop(r.extend({}, s, {drop_zone: n}));
                        o.onready = function () {
                            var n = f.getInfo(this.ruid);
                            r.extend(u.features, {
                                chunks: n.can("slice_blob"),
            ...
            function it(n, i, e) {
                function c(n, i, f) {
                    ...
                    switch (n) {
                        ...
                        case"unique_names":
                            ...
                            break;
                        case"filters":
                            r.typeOf(i) === "array" && (i = {mime_types: i});
                            ...
                            break;
                        case"resize":
                            u.resize = i ? r.extend({preserve_headers: !0, crop: !1}, i) : !1;
                            break;
                ...
                e ? (u.required_features = s(r.extend({}, u)), p = s(r.extend({}, u, {required_features: !0}))) : h && (o.trigger("Destroy"), tt.call(o, u, function (n) {
                    n ? (o.runtime = f.getInfo(d()).type, o.trigger("Init", {runtime: o.runtime}), o.trigger("PostInit")) : o.trigger("Error", {
                        code: r.INIT_ERROR,
            ...
            function et(n, i) {
                ...
                var s = n.settings.url, o = n.settings.chunk_size, v = n.settings.max_retries, l = n.features, f = 0, u,
                    a = {
            ...
            function st(n) {
                if (n.state == r.STARTED) w = +new Date; else if (n.state == r.STOPPED) for (var t = n.files.length - 1; t >= 0; t--) n.files[t].status == r.UPLOADING && (n.files[t].status = r.QUEUED, b())
            }
            ...
            var g = r.guid(), u, c = [], p = {}, a = [], v = [], w, l, y = !1, h;
            u = {
                chunk_size: 0,
                file_data_name: "file",
            ...
            r.extend(this, {
                ...
                init: function () {
                    ...
                    tt.call(n, u, function (t) {
                        var i = n.getOption("init"), u;
                        typeof i == "function" ? i(n) : r.each(i, function (t, i) {
                            n.bind(i, t)
                        });
                        t ? (u = f.getInfo(d()), n.runtime = u.type, n.trigger("Init", {runtime: u}), n.trigger("PostInit")) : n.trigger("Error", {
                            code: r.INIT_ERROR,
                            message: r.translate("Init error.")
                        })
                    })
                ...
                getFile: function (n) {
                    for (var t = c.length - 1; t >= 0; t--) if (c[t].id === n) return c[t]
                },
                ...
                removeFile: function (n) {
                    for (var i = typeof n == "string" ? n : n.id, t = c.length - 1; t >= 0; t--) if (c[t].id === i) return this.splice(t, 1)[0]
                },
                splice: function (n, t) {
                    var u = c.splice(n === i ? 0 : n, t === i ? c.length : t), f = !1;
                ...
                dispatchEvent: function (n) {
                    var t, r, i;
                    if (n = n.toLowerCase(), t = this.hasEventListener(n), t) for (t.sort(function (n, t) {
                        return t.priority - n.priority
                    }), r = [].slice.call(arguments), r.shift(), r.unshift(this), i = 0; i < t.length; i++) if (t[i].fn.apply(t[i].scope, r) === !1) return !1;
                    return !0
                },
...
Ext.define("StolenTech.FileUltimate.FileUploader", {
    extend: "Ext.panel.Panel",
    mixins: ["StolenTech.UI.ServerHandler", "StolenTech.UI.ActionHandler", "StolenTech.UI.EventHandler"],
    statics: {
        sprite: new StolenTech.UI.Sprite("explorerviewicons"),
        sprite2: new StolenTech.UI.Sprite("filemanagericons")
    },
    config: {
        resourceBasePath: "",
        viewLayout: "details",
        ...
        viewCheckboxSelection: !1,
        showFileExtensions: !1,
        uploadHandlerType: "StolenTech.FileUltimate.PlUploadHandler",
    ...
    busyManager: null,
    uploadHandler: null,
    allowedFileTypes: {items: [], regExp: null, text: ""},
    deniedFileTypes: {items: [], regExp: null, text: ""},
    constructor: function (n) {
        this.mixins.serverHandler.constructor.call(this, n);
        this.mixins.actionHandler.constructor.call(this, n);
        this.mixins.eventHandler.constructor.call(this, n);
    ...
    doDestroy: function () {
        this.reset();
        StolenTech.Util.Dom.unregisterPageLeave(this.onPageLeave, this);
        this.callParent();
        Ext.destroy(this.viewStore, this.viewContainerContextMenu, this.viewItemContextMenu, this.uploadHandler)
    },
    applyFileTypes: function (n, t) {
        var u, i, r;
        return (n = StolenTech.Util.String.trim(n || ""), n || (n = this.defaultConfig.fileTypes), n === t) ? t : (u = n.split("/"), i = this.allowedFileTypes, i.items = u[0].split("|"), Ext.Array.forEach(i.items, function (n, t, i) {
            i[t] = StolenTech.Util.String.trim(n)
    ...
    createFileTypesRegex: function (n) {
        for (var r, u, t = "^(", i = 0; i < n.length; i++) r = StolenTech.Util.String.trim(n[i]), u = StolenTech.Util.String.escapeRegExpPattern(r), t += u.replace(/\\\?/g, ".").replace(/\\\*/g, ".*"), i < n.length - 1 && (t += "|");
        return t += ")$", new RegExp(t, "i")
    },
    updateMaxFileSize: function (n) {
        this.maxFileSizeInBytes = StolenTech.Util.Culture.parseByteSize(n)
    },
    updateChunkSize: function (n) {
        this.chunkSizeInBytes = StolenTech.Util.Culture.parseByteSize(n);
    ...
    initComponent: function () {
        ...
        n.push({
            ...
            xtype: "container",
            layout: "absolute",
            defaults: {style: {zIndex: 0}},
            items: [this.bottomToolbar = this.createBottomToolbar(), this.progressToolbar = this.createProgressToolbar()]
        });
        Ext.apply(this, {
            layout: {type: "border"},
            defaults: {border: !1},
            items: n,
            listeners: {beforehide: this.onBeforeHide, scope: this}
        });
        this.busyManager = new StolenTech.UI.BusyManager({
            listeners: {
                showBusy: {fn: this.onShowBusy, scope: this},
    ...
    afterRender: function () {
        this.callParent(arguments);
        StolenTech.Util.Dom.registerPageLeave(this.onPageLeave, this);
        this.uploadHandler = Ext.create(this.uploadHandlerType, {
            resourceBasePath: this.resourceBasePath,
            selectFileButton: this.bottomToolbar.down("button[itemId=AddFiles]").el.dom,
            selectFolderButton: this.bottomToolbar.down("button[itemId=AddFolders]").el.dom,
    ...
    onShow: function () {
        this.callParent(arguments);
        this.uploadHandler && this.uploadHandler.uploadMethod && this.hasListener("ready") && this.fireEventEx("ready", new StolenTech.UI.EventArgs({
            uploadMethod: this.uploadHandler.uploadMethod,
            uploadMethodFeatures: this.uploadHandler.uploadMethodFeatures
        }))
    },
    onBeforeHide: function () {
        return this.isDestroying ? !0 : this.hideConfirmed ? (delete this.hideConfirmed, !0) : this.isInProgress() ? (this.messageBox.showConfirm({
            message: StolenTech.Util.Language.getEntry("Message.Confirm.UploadStillInProgress"),
            fn: function (n) {
                n === "yes" && (this.hideConfirmed = !0, this.hide())
            },
            scope: this
        }), !1) : !0
    },
    onPageLeave: function (n) {
        this.isInProgress() && (n.message = StolenTech.Util.Language.getEntry("Message.Confirm.UploadStillInProgress"))
    },
    onHide: function () {
        this.reset();
        this.callParent(arguments)
    ...
    reset: function () {
        this.stop();
        this.onActionClear();
        this.multiView.revertViewLayout()
    },
    initLabels: function () {
    },
    initActions: function () {
        ...
        }, {actionName: "AddFolders", languageKey: "Label.AddFolders"}, {
            actionName: "Remove",
            languageKey: "Label.Remove"
        }, {actionName: "Clear", languageKey: "Label.Clear"}, {
            actionName: "UploadMethod",
            languageKey: "Label.UploadMethod"
        }, {actionName: "ViewInfo", languageKey: "Label.ViewInfo"}, {
            actionName: "Upload",
            languageKey: "Label.Upload.Verb"
        }, {actionName: "Cancel", languageKey: "Label.Cancel"}, {
            actionName: "CancelAll",
            languageKey: "Label.CancelAll"
        }], this.statics().sprite)
    },
    initStores: function () {
        this.viewStore = new StolenTech.FileUltimate.UploadStore({
            model: "StolenTech.FileUltimate.UploadModel",
            listeners: {scope: this, datachanged: this.onViewStoreDataChanged}
        })
    },
    createInfoBar: function () {
        var n = new Ext.toolbar.Toolbar({
            ...
            items: [new Ext.Component({
                ...
                height: 32,
                margin: "0 6 0 0",
                cls: this.statics().sprite2.getIcon("Upload").getIconCls(32)
            }), this.infoBarTitle = new Ext.Component({cls: "x-infobar-title", bind: {html: "{infoBarTitle}"}})]
        });
    ...
    createMultiView: function () {
        return new StolenTech.UI.MultiView({
            region: "center",
            store: this.viewStore,
            columns: this.getViewColumnsConfig(),
            viewLayout: this.viewLayout,
            ...
            getItemIconCls: {fn: this.getItemIconCls, scope: this},
            getItemThumbnailSrc: {fn: this.getItemThumbnailSrc, scope: this},
            getItemDynamicThumbnailSrc: {fn: this.getItemDynamicThumbnailSrc, scope: this},
            enableNativeDrop: !0,
    ...
    getViewColumnsConfig: function (n) {
        var u = this, f = {
            name: {
                ...
                dataIndex: "name",
                formatterFn: function (n, t) {
                    return !u.showFileExtensions && t.data.itemType === StolenTech.FileUltimate.UploadItemType.File ? StolenTech.Util.Path.getFileNameWithoutExtension(n) : n
                },
                htmlEncode: !0,
                hideable: !1,
                isPrimary: !0,
            ...
            type: {
                ...
                isTileFirstValue: !0,
                tileFormatterFn: function (n, t) {
                    return t.data.itemType === StolenTech.FileUltimate.UploadItemType.File ? n : ""
                },
                htmlEncode: !0,
                isToolTipValue: !0,
                width: 125
            ...
            size: {
                ...
                isTileSecondValue: !0,
                tileFormatterFn: function (n, t) {
                    return t.data.itemType === StolenTech.FileUltimate.UploadItemType.File ? StolenTech.Util.Culture.formatByteSize(n) : ""
                },
                isToolTipValue: !0,
                width: 85
            },
            status: {
                text: StolenTech.Util.Language.getEntry("Label.Column.Status"),
                width: 100,
                xtype: "widgetcolumn",
                dataIndex: "status",
                sortable: !0,
                widget: {
                    ...
                    showDetails: function (n) {
                        var t = Ext.clone(n.details), i = this.getWidgetRecord();
                        t.title += " - " + i.data.name;
                        u.messageBox.showError(t)
                    }
                }
            }
        }, i, t, r;
    ...
    getItemIconCls: function (n, t) {
        var i = n.data;
        switch (i.itemType) {
            case StolenTech.FileUltimate.UploadItemType.Folder:
                return StolenTech.FileUltimate.FileTypeInfo.getBaseIconCls("Folder", t);
            case StolenTech.FileUltimate.UploadItemType.File:
                return StolenTech.FileUltimate.FileTypeInfo.getIconCls(i.extension, t);
            default:
                return ""
        }
    ...
    getItemThumbnailSrc: function (n) {
        ...
        var t = n.data;
        return t.itemType !== StolenTech.FileUltimate.UploadItemType.File || t.size === 0 ? "" : this.uploadHandler.isThumbnailExtension(t.extension) ? "{dynamic}" : ""
    },
    getItemDynamicThumbnailSrc: function (n, t, i, r) {
        var f = n.data.thumbnails, u;
        if (f && (u = f[t], u)) {
            i(u);
            return
        }
    ...
    createStatusBar: function (n) {
        return new StolenTech.UI.MultiViewStatusBar({
            region: "south",
            multiView: n,
            getDataStatusText: {fn: this.getTotalSize, scope: this},
            getSelectionStatusText: {fn: this.getTotalSize, scope: this}
        })
    },
    getTotalSize: function (n) {
        ...
        for (t = 0; t < r; t++) u = n[t], u.data.itemType === StolenTech.FileUltimate.UploadItemType.File && (i += u.data.size);
        return StolenTech.Util.Culture.formatByteSize(i)
    },
    createProgressToolbar: function () {
        return new Ext.toolbar.Toolbar({
            ...
            items: [{
                xtype: "displayfield",
                fieldLabel: StolenTech.Util.Language.getEntry("Label.TimeRemaining"),
                bind: "{timeRemaining}"
            }, {
                xtype: "displayfield",
                fieldLabel: StolenTech.Util.Language.getEntry("Label.ItemsRemaining"),
                bind: "{itemsRemaining}"
            }, {
                xtype: "displayfield",
                fieldLabel: StolenTech.Util.Language.getEntry("Label.Speed"),
                bind: "{speed}"
            }, {
                xtype: "toolbar",
                ui: "footer",
                ...
                items: [{
                    ...
                    flex: 1,
                    bind: "{progress}"
                }, this.applyControlAction({bind: {disabled: "{!inProgress}"}}, "CancelAll")]
            }],
            bind: {hidden: "{!inProgress}"}
        })
    },
    createBottomToolbar: function () {
        return new Ext.toolbar.Toolbar({
            ...
            overflowHandler: "scroller",
            defaults: {minWidth: 80},
            items: [this.applyControlAction({bind: {disabled: "{!canAddFile}"}}, "AddFiles"), this.applyControlAction({bind: {disabled: "{!canAddFolder}"}}, "AddFolders"), this.applyControlAction({bind: {disabled: "{!hasAnySelection}"}}, "Remove"), this.applyControlAction({bind: {disabled: "{!hasAnyRecords}"}}, "Clear"), "->", this.applyControlAction({bind: {disabled: "{!canStartUpload}"}}, "Upload")]
        })
    },
    createMessageBox: function () {
        return new StolenTech.UI.MessageBox({
            ...
            conflictText: {
                message: StolenTech.Util.Language.getEntry("Message.FileConflict"),
                actionMessage: StolenTech.Util.Language.getEntry("Message.FileConflictAction"),
                replaceTitle: StolenTech.Util.Language.getEntry("Label.FileConflictReplace"),
                replaceDescription: StolenTech.Util.Language.getEntry("Message.FileConflictReplace"),
                skipTitle: StolenTech.Util.Language.getEntry("Label.FileConflictSkip"),
                skipDescription: StolenTech.Util.Language.getEntry("Message.FileConflictSkip"),
                keepBothTitle: StolenTech.Util.Language.getEntry("Label.FileConflictKeepBoth"),
                keepBothDescription: StolenTech.Util.Language.getEntry("Message.FileConflictKeepBoth"),
                nextConflicts: StolenTech.Util.Language.getEntry("Message.FileConflictSameForNext"),
                allConflicts: StolenTech.Util.Language.getEntry("Message.FileConflictSameForAll")
            }
        })
    },
    createViewContainerContextMenu: function () {
        return new Ext.menu.Menu({
            ...
            }, "Clear", 16), this.applyControlAction({bind: {hidden: "{!inProgress}"}}, "CancelAll", 16), {xtype: "menuseparator"}, this.applyControlAction({
                bind: {hidden: "{inProgress}"},
                menu: this.uploadMethodMenu = this.createUploadMethodMenu()
            }, "UploadMethod", 16), {xtype: "menuseparator"}, this.applyControlAction({}, "SelectAll", 16)]
        })
    },
    createUploadMethodMenu: function () {
        for (var t, u, r = Ext.ClassManager.get(this.uploadHandlerType).supportedUploadMethods, n = [], i = 0; i < r.length; i++) t = r[i], u = this.applyControlAction({
            itemId: "UploadMethod" + t,
            xtype: "menucheckitem",
            text: t,
            group: "UploadMethod",
            value: t,
            checkChangeOnClickDisabled: !0
        }, "UploadMethod"), n.push(u);
        return n.push({xtype: "menuseparator"}), n.push(this.applyControlAction({}, "ViewInfo", 16)), new Ext.menu.Menu({
            items: n,
            setUploadMethod: function (n) {
                var t = this.child("[group='UploadMethod'][value='" + n + "']");
                t ? t.setChecked(!0, !1) : (t = this.child("[group='UploadMethod'][checked]"), t && t.setChecked(!1, !1))
            },
            bind: {uploadMethod: "{uploadMethod}"}
        })
    },
    createViewItemContextMenu: function () {
        return new Ext.menu.Menu({
            ...
            }, "Remove", 16), this.applyControlAction({bind: {hidden: "{!inProgress}"}}, "Cancel", 16), {xtype: "menuseparator"}, this.applyControlAction({}, "SelectAll", 16), this.applyControlAction({}, "SelectNone", 16), this.applyControlAction({}, "InvertSelection", 16)]
        })
    },
    onViewStoreDataChanged: function (n) {
        this.viewModel.setAndNotify({hasAnyRecords: n.getCount() > 0, hasAnyPendingRecords: n.hasAnyPending()})
    },
    onViewLayoutChange: function (n, t, i) {
        this.getControlAction("ToggleLayout" + t.name).each(function (n) {
            n.toggleUIOnly(!0)
    ...
    onViewNativeDragEnter: function (n, t) {
        ...
        i && t.hasFiles ? t.proxy.setStatusText(StolenTech.Util.Language.getEntry("Label.AddToUploadQueue"), "x-dd-status-uploadto") : t.proxy.setStatusNotAllowed()
    },
    onViewNativeDrop: function (n, t) {
        var r, i;
        this.isInProgress() || (r = this.uploadHandler && this.uploadHandler.uploadMethod && this.uploadHandler.uploadMethodFeatures && this.uploadHandler.uploadMethodFeatures.dragAndDrop, r && t.hasFiles) && (i = this, StolenTech.FileUltimate.FileDropHelper.getFilesFromEvent(t.e.browserEvent, function (n) {
    ...
    onViewSelectionChange: function (n, t) {
        this.viewSelection = t;
        this.viewModel.setAndNotify({hasAnySelection: t.length > 0})
    },
    showAddConflicts: function (n, t) {
        ...
        this.messageBox.showWarning({
            title: StolenTech.Util.Language.getEntry("Label.AddConflict"),
            message: i.message,
            htmlEncodeMessage: !1,
            fn: function () {
    ...
    showUploadConflicts: function (n, t, i, r) {
        ...
        e = function (i, r) {
            switch (i) {
                case"skip":
                    u.record.set("status", f.getStatusData(StolenTech.FileUltimate.UploadStatus.Skipped));
                    break;
                case"keepboth":
                    u.record.set("oldName", u.record.data.name);
                    u.record.set("name", u.itemCopyName);
                    break;
                case"cancel":
                    f.stop();
                    return
        ...
        r ? e(i, r) : this.messageBox.showConflict({
            title: StolenTech.Util.Language.getEntry("Label.UploadConflict"),
            conflictConfig: {
    ...
    getStatusData: function (n, t, i) {
        var r = {value: n, details: t};
        switch (n) {
            case StolenTech.FileUltimate.UploadStatus.Pending:
                Ext.apply(r, {text: StolenTech.Util.Language.getEntry("Label.Status.Pending")});
                break;
            case StolenTech.FileUltimate.UploadStatus.Rejected:
                Ext.apply(r, {text: StolenTech.Util.Language.getEntry("Label.Status.Rejected"), color: "red"});
                break;
            case StolenTech.FileUltimate.UploadStatus.Skipped:
                Ext.apply(r, {text: StolenTech.Util.Language.getEntry("Label.Status.Skipped"), color: "navy"});
                break;
            case StolenTech.FileUltimate.UploadStatus.Uploading:
                Ext.apply(r, {progress: i});
                break;
            case StolenTech.FileUltimate.UploadStatus.Canceled:
                Ext.apply(r, {text: StolenTech.Util.Language.getEntry("Label.Status.Canceled"), color: "orange"});
                break;
            case StolenTech.FileUltimate.UploadStatus.Failed:
                Ext.apply(r, {text: StolenTech.Util.Language.getEntry("Label.Status.Failed"), color: "red"});
                break;
            case StolenTech.FileUltimate.UploadStatus.Completed:
                Ext.apply(r, {text: StolenTech.Util.Language.getEntry("Label.Status.Completed"), color: "green"})
        }
        return r
    },
    onQueueStatusChange: function (n, t) {
        switch (n) {
            case StolenTech.FileUltimate.QueueStatus.Starting:
                this.viewModel.setAndNotify({inProgress: !0, queueId: StolenTech.Util.String.createUniqueId()});
                this.multiView.lockViewLayout("details");
                this.viewStore.sort({property: "internalId", direction: "ASC", root: ""});
                break;
            case StolenTech.FileUltimate.QueueStatus.Started:
                this.viewModel.setAndNotify({totalCount: t.totalCount, totalSize: t.totalSize});
                break;
            case StolenTech.FileUltimate.QueueStatus.FileStarted:
                this.viewModel.data.processedCount === 0 && this.viewModel.setAndNotify({
                    startTime: (new Date).getTime(),
                    fileProcessedSize: 0,
                    fileProgress: 0
                });
                break;
            case StolenTech.FileUltimate.QueueStatus.FileProcessing:
                this.viewModel.setAndNotify({fileProcessedSize: t.fileProcessedSize, fileProgress: t.fileProgress});
                break;
            case StolenTech.FileUltimate.QueueStatus.FileStopped:
                this.viewModel.setAndNotify({
                    processedSize: this.viewModel.get("processedSize") + this.viewModel.get("fileProcessedSize"),
                    processedCount: this.viewModel.get("processedCount") + 1,
                    fileProcessedSize: 0,
                    fileProgress: 0
                });
                break;
            case StolenTech.FileUltimate.QueueStatus.Stopped:
                var i = this.viewModel.defaultConfig.data;
                this.viewModel.setAndNotify({
                    ...
                    processedSize: i.processedSize,
                    processedCount: i.processedCount,
                    progress: i.progress,
                    fileProcessedSize: i.fileProcessedSize,
    ...
    getEventItems: function (n) {
        for (var t, r = [], i = 0; i < n.length; i++) t = n[i], r.push({
            itemType: Ext.Object.getKey(StolenTech.FileUltimate.UploadItemType, t.data.itemType),
            name: t.data.name,
            nameWithoutPath: t.data.nameWithoutPath,
            extension: t.data.extension,
            oldName: t.data.oldName,
            dateModified: t.data.dateModified,
            type: t.data.type,
            size: t.data.size,
            status: Ext.Object.getKey(StolenTech.FileUltimate.UploadStatus, t.data.status.value)
        });
        return r
    },
    onCancelEvent: function (n) {
    ...
    isInProgress: function () {
        return this.viewModel && this.viewModel.data.inProgress
    },
    start: function () {
        this.isInProgress() || this.onBeginQueue()
    },
    onBeginQueue: function () {
        var i, t, n, u;
        this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.Starting);
        i = this.viewStore.getData().items;
        this.queuedRecords = [];
        var f = this.uploadHandler.uploadMethodFeatures.reportFileSize,
            e = this.uploadHandler.uploadMethodFeatures.reportFileDate, r = [];
        for (t = 0; t < i.length; t++) (n = i[t], n.data.status.value === StolenTech.FileUltimate.UploadStatus.Pending) && (this.queuedRecords.push(n), r.push({
            id: n.data.id,
            name: n.data.name,
            size: f ? n.data.size : null,
            dateModified: e ? Ext.Date.format(n.data.dateModified, "C") : null
        }));
        if (!this.queuedRecords.length) {
            this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.Stopped);
            return
        }
        if (this.hasListener("uploading") && (u = this.fireEventEx("uploading", new StolenTech.UI.EventArgs({
        ...
        this.callServerHandlerMethod({
            name: "BeginQueue",
            parameters: {
                queueId: this.viewModel.data.queueId,
            ...
            callback: function (n, t) {
                var f, u, i, r;
                if (!t) {
                    for (f = [], u = 0; u < this.queuedRecords.length; u++) if (i = this.queuedRecords[u], r = n[i.data.id], r) switch (r.Action) {
                        case StolenTech.FileUltimate.ValidationAction.Accept:
                            continue;
                        case StolenTech.FileUltimate.ValidationAction.Reject:
                            i.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Rejected, r.Reason));
                            continue;
                        case StolenTech.FileUltimate.ValidationAction.ConfirmReplace:
                            r.RenameData && (i.set("oldName", i.data.name), i.set("name", r.RenameData));
                            f.push({
                                record: i,
                                newRecord: new StolenTech.FileUltimate.UploadModel({
                                    itemType: i.data.itemType,
                                    name: r.ReplaceData.ExistingFileName,
                                    size: i.data.size,
                                    dateModified: i.data.dateModified
                                }),
                                existingRecord: new StolenTech.FileUltimate.UploadModel({
                                    itemType: i.data.itemType,
                                    name: r.ReplaceData.ExistingFileName,
                                    size: r.ReplaceData.ExistingFileSize,
                                    dateModified: r.ReplaceData.ExistingFileDate
                                }),
                                itemCopyName: r.ReplaceData.NewFileName
                            });
                            break;
                        case StolenTech.FileUltimate.ValidationAction.Rename:
                            i.set("oldName", i.data.name);
                            i.set("name", r.RenameData)
                    }
                    this.showUploadConflicts(f, this.onConflictsResolved)
                }
            },
            scope: this
        })
    ...
    onConflictsResolved: function () {
        for (var n, r = [], t = [], u = this.uploadHandler.uploadMethodFeatures.reportFileSize, f = u ? 0 : null, i = 0; i < this.queuedRecords.length; i++) n = this.queuedRecords[i], n.data.status.value === StolenTech.FileUltimate.UploadStatus.Pending ? (u && n.data.itemType === StolenTech.FileUltimate.UploadItemType.File && (f += n.data.size), t.push(n)) : n.data.status.value === StolenTech.FileUltimate.UploadStatus.Skipped && r.push(n.data.id);
        this.onSkipItems(r, function () {
            if (!t.length) {
                this.onEndQueue();
                return
            }
            this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.Started, {totalCount: t.length, totalSize: f});
            this.onUploadNext()
        })
    },
    onSkipItems: function (n, t) {
        n.length ? this.callServerHandlerMethod({
            name: "SkipItems",
            parameters: {queueId: this.viewModel.data.queueId, uploadIds: n},
            callback: t,
            scope: this
        }) : Ext.callback(t, this, [!0])
    },
    onUploadNext: function () {
        StolenTech.Util.Function.runDetached(function () {
            var n, t;
            if (this.isInProgress()) {
                for (n = 0; n < this.queuedRecords.length; n++) {
                    if (t = this.queuedRecords[n], t.data.status.value === StolenTech.FileUltimate.UploadStatus.Uploading) return;
                    if (t.data.status.value === StolenTech.FileUltimate.UploadStatus.Pending) {
                        this.onUpload(t);
                        return
                    }
                }
    ...
    onUpload: function (n) {
        var i, t;
        if (this.hasListener("itemuploading") && (i = this.fireEventEx("itemuploading", new StolenTech.UI.EventArgs({
            item: this.getEventItems([n])[0],
            uploadMethod: this.uploadHandler.uploadMethod,
            uploadMethodFeatures: this.uploadHandler.uploadMethodFeatures
        })), i === !1)) {
            n.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Skipped));
            this.onSkipItems([n.data.id], this.onUploadNext);
            return
        }
        var r = this.uploadHandler.uploadMethodFeatures.reportProgress,
            u = this.uploadHandler.uploadMethodFeatures.uploadAsBinary,
            f = this.uploadHandler.uploadMethodFeatures.uploadAsChunks,
            e = this.getServerHandlerMethodUrl(u && f ? "UploadAsBinary" : "UploadAsForm", {
                queueId: this.viewModel.data.queueId,
                uploadId: n.data.id,
                newName: n.data.oldName ? n.data.name : null
            });
        this.multiView.activeView.focusNode(n);
        n.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Uploading, null, 0));
        this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.FileStarted);
        this.uploadHandler.uploadFile(n, e);
        t = this;
        r ? this.viewModel.data.processedCount === 0 && function s() {
            setTimeout(function () {
                !t.isDestroyed && t.isInProgress() && t.callServerHandlerMethod({
            ...
            setTimeout(function () {
                t.isDestroyed || !t.isInProgress() || n.destroyed || n.data.status.value !== StolenTech.FileUltimate.UploadStatus.Uploading || t.callServerHandlerMethod({
                    name: "GetItemProgress",
                    parameters: {queueId: t.viewModel.data.queueId, uploadId: n.data.id, first: r},
                    callback: function (i, r) {
                        if (!r && i && t.isInProgress() && !n.destroyed && n.data.status.value === StolenTech.FileUltimate.UploadStatus.Uploading) {
                            i.Size !== null && n.data.size === null && n.set("size", i.Size);
                            t.onUploadProgress(n, i.UploadedSize);
                            o(2e3, !1)
                        }
                    }
                })
    ...
    onFailItem: function (n, t, i) {
        this.callServerHandlerMethod({
            name: "FailItem",
            parameters: {queueId: this.viewModel.data.queueId, uploadId: n.data.id, clientError: t},
            callback: i,
            scope: this
        })
    },
    onCancelItems: function (n, t) {
        for (var i, r = [], u = 0; u < n.length; u++) if (i = n[u], i.data.status.value === StolenTech.FileUltimate.UploadStatus.Uploading || i.data.status.value === StolenTech.FileUltimate.UploadStatus.Pending) {
            this.uploadHandler.cancelFile(i);
            i.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Canceled));
            this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.FileProcessing, {
                fileProcessedSize: i.data.size || 0,
                fileProgress: 1
            });
            this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.FileStopped);
            r.push(i.data.id)
        }
        r.length ? this.callServerHandlerMethod({
            name: "CancelItems",
            parameters: {queueId: this.viewModel.data.queueId, uploadIds: r},
            callback: t,
            scope: this
        }) : Ext.callback(t, this, [!0])
    },
    onEndQueue: function () {
        this.callServerHandlerMethod({
            name: "EndQueue",
            parameters: {queueId: this.viewModel.data.queueId},
            callback: function (n, t) {
                var r, i, u;
                this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.Stopped);
                if (this.hasListener("uploaded") && this.fireEventEx("uploaded", new StolenTech.UI.EventArgs({
                    items: this.getEventItems(this.queuedRecords),
                    uploadMethod: this.uploadHandler.uploadMethod,
                    uploadMethodFeatures: this.uploadHandler.uploadMethodFeatures
                })), this.autoClose) {
                    for (r = !0, i = 0; i < this.queuedRecords.length; i++) if (u = this.queuedRecords[i], u.data.status.value !== StolenTech.FileUltimate.UploadStatus.Completed) {
                        r = !1;
                        break
                    }
                    r && !t && this.close()
    ...
    stop: function () {
        if (this.isInProgress()) this.onCancelItems(this.queuedRecords, this.onEndQueue)
    },
    onServerHandlerMethodEnd: function (n, t, i) {
        if (i) {
            ...
            i.sessionExpired ? this.confirmRefreshPage() : this.messageBox.showError(i)
        }
    },
    confirmRefreshPage: function () {
        this.messageBox.showConfirm({
    ...
    onUploadHandlerLoad: function (n) {
        this.viewModel.setAndNotify({uploadMethod: n.uploadMethod, uploadMethodFeatures: n.uploadMethodFeatures});
        this.hasListener("ready") && this.fireEventEx("ready", new StolenTech.UI.EventArgs({
            uploadMethod: n.uploadMethod,
            uploadMethodFeatures: n.uploadMethodFeatures
        }))
    },
    onUploadHandlerLoadError: function (n, t) {
        var i = Ext.browser.name + " " + Ext.browser.version.major,
            r = Ext.isArray(t) ? StolenTech.Util.Language.getEntry("Message.Error.AnyUploadMethod", t.join(", "), i) : StolenTech.Util.Language.getEntry("Message.Error.SpecificUploadMethod", t, i);
        this.messageBox.showWarning(r)
    },
    onUploadHandlerUnload: function (n) {
        this.onActionClear();
        this.viewModel.setAndNotify({uploadMethod: n.uploadMethod, uploadMethodFeatures: n.uploadMethodFeatures})
    },
    onUploadHandlerAddFiles: function (n, t) {
        for (var r, u, i, c = [], f = [], e = [], o = [], s = [], h = 0; h < t.length; h++) {
            if (r = t[h], this.viewStore.getByName(r.data.name)) {
                f.push(r);
                continue
            }
            ...
            if (this.maxFileCount && h >= this.maxFileCount) {
                s.push(r);
                continue
            }
            c.push(r);
            r.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Pending))
        }
        (this.autoStart || this.autoStartOnce) && this.multiView.lockViewLayout("details");
        this.viewStore.add(c);
        u = [];
        f.length > 0 && (i = StolenTech.Util.Language.getEntry("Message.Error.ItemsAlreadyAdded"), u.push({
            message: i,
            records: f
        }));
        e.length > 0 && (i = StolenTech.Util.Language.getEntry("Message.Error.ItemsFileTypeNotAllowed"), i += "\n", this.allowedFileTypes.text && (i += "\n" + StolenTech.Util.Language.getEntry("Label.Info.AllowedFileTypes", "<b>" + this.allowedFileTypes.text + "<\/b>")), this.deniedFileTypes.text && (i += "\n" + StolenTech.Util.Language.getEntry("Label.Info.DeniedFileTypes", "<b>" + this.deniedFileTypes.text + "<\/b>")), u.push({
            message: i,
            records: e
        }));
        o.length > 0 && (i = StolenTech.Util.Language.getEntry("Message.Error.ItemsFileSizeNotAllowed"), i += "\n", i += "\n" + StolenTech.Util.Language.getEntry("Label.Info.AllowedMaxFileSize", "<b>" + StolenTech.Util.Culture.formatKBSize(this.maxFileSizeInBytes) + "<\/b>"), u.push({
            message: i,
            records: o
        }));
        s.length > 0 && (i = StolenTech.Util.Language.getEntry("Message.Error.ItemsFileCountNotAllowed"), i += "\n", i += "\n" + StolenTech.Util.Language.getEntry("Label.Info.AllowedMaxFileCount", "<b>" + this.maxFileCount + "<\/b>"), u.push({
            message: i,
            records: s
        }));
        this.showAddConflicts(u, function () {
            Ext.Array.forEach(f, function (t) {
                n.destroyFile(t)
            });
            ...
            (this.autoStart || this.autoStartOnce) && (delete this.autoStartOnce, c.length ? this.start() : this.multiView.unlockViewLayout(!0))
        })
    },
    ...
    onUploadProgress: function (n, t) {
        if (n.data.status.value === StolenTech.FileUltimate.UploadStatus.Uploading) {
            t = t || 0;
            var i = n.data.size > 0 ? t / n.data.size : 0;
            n.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Uploading, null, i));
            this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.FileProcessing, {
                fileProcessedSize: t,
                fileProgress: i
            })
    ...
    onUploadHandlerFileEnd: function (n, t, i) {
        var r, u;
        if (!this.isDestroyed && t.data.status.value !== StolenTech.FileUltimate.UploadStatus.Canceled) {
            this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.FileProcessing, {
            ...
            this.onQueueStatusChange(StolenTech.FileUltimate.QueueStatus.FileStopped);
            if (i.errorResult) {
                if (r = i.errorResult, (r.responseStatus === 413 || r.responseStatus === 400) && (r.message += "\n\nServer rejected the upload due to request limits, please modify your configuration.", this.maxRequestSize && (r.message += "\nReported maxRequestSize: " + StolenTech.Util.Culture.formatByteSize(this.maxRequestSize)), this.uploadHandler.uploadMethodFeatures.uploadAsChunks && (r.message += "\nReported chunkSize: " + StolenTech.Util.Culture.formatByteSize(this.chunkSizeInBytes))), t.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Failed, r)), r.isResponseError || r.isHttpError) this.onFailItem(t, r.title + ": " + r.message, this.onUploadNext);
                if (r.isConnectionError || r.sessionExpired) {
                    if (!this.isInProgress()) return;
                    this.stop();
                    r.sessionExpired ? this.confirmRefreshPage() : this.messageBox.showError(r);
                    return
                }
            } else u = i.successResult, u.IsCanceled ? t.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Canceled)) : u.IsRejected ? t.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Rejected, u.Reason)) : (t.data.size === null && t.set("size", u.UploadedSize), t.set("status", this.getStatusData(StolenTech.FileUltimate.UploadStatus.Completed)), this.hasListener("itemuploaded") && this.fireEventEx("itemuploaded", new StolenTech.UI.EventArgs({
    ...
    onActionSelectAll: function () {
        this.multiView.getSelectionModel().selectAll()
    },
    onActionSelectNone: function () {
        this.multiView.getSelectionModel().deselectAll()
    },
    onActionInvertSelection: function () {
    ...
    onActionClear: function () {
        var n = this.viewStore.getData().items;
        this.removeFiles(n)
    },
    removeFiles: function (n) {
        for (var r, i = this.viewStore.remove(n), t = 0; t < i.length; t++) r = i[t], this.uploadHandler.destroyFile(r)
    },
    onActionUploadMethod: function (n) {
        var t = n, i = t.value;
        this.uploadHandler.load(i)
    },
    onActionViewInfo: function () {
        var u = Ext.browser.name + " " + Ext.browser.version.major, n = "", f = function (t, i) {
            n += Ext.String.format('{0}: <span style="color:{1}">{2}<\/span><br/>', t, i ? "green" : "red", StolenTech.Util.Language.getEntry(i ? "Label.Yes" : "Label.No"))
        }, t = function (t, i) {
            n += Ext.String.format('{0}: <span style="color:{1}">{2}<\/span><br/>', t, i ? "green" : "red", i ? Ext.String.endsWith(t, "Size") ? StolenTech.Util.Culture.formatByteSize(i) : i : "-")
        }, i, r;
        n += "<b>Client features:<\/b><br/>";
        n += Ext.String.format('method: <span style="color: green">{0} ({1})<\/span><br/>', this.uploadHandler.uploadMethod || "No upload method", u);
        Ext.Object.each(this.uploadHandler.uploadMethodFeatures, f);
        i = {maxRequestSize: this.maxRequestSize, chunkSize: this.chunkSizeInBytes};
        n += "<br/>";
        n += "<b>Server features:<\/b><br/>";
        Ext.Object.each(i, t);
        r = {
            allowedMaxFileSize: this.maxFileSizeInBytes,
            allowedFileTypes: this.allowedFileTypes.text,
            deniedFileTypes: this.deniedFileTypes.text
        };
        n += "<br/>";
        n += "<b>User restrictions:<\/b><br/>";
        Ext.Object.each(r, t);
        this.messageBox.showInfo({message: n, htmlEncodeMessage: !1})
    },
    ...
    onActionCancel: function () {
        var n = this.viewSelection;
        this.onCancelItems(n, this.onUploadNext)
    },
    onActionCancelAll: function () {
        this.stop()
    }
});
Ext.define("StolenTech.FileUltimate.UploadModel", {
    extend: "Ext.data.Model",
    fields: [{name: "itemType"}, {
        name: "name", sortType: "asLocaleString", convert: function (n) {
            return StolenTech.Util.String.trim(n.replace(/\//g, "\\"), "\\")
        }
    }, {name: "oldName", sortType: "asLocaleString"}, {
        name: "dateModified",
        type: "date",
        dateFormat: "c"
    }, {name: "size"}, {
        name: "status", sortType: function (n) {
            n = n || {};
            var t = n.value || 0;
            return n.progress && (t += n.progress), t
        }
    }, {
        name: "nameWithoutPath", calculate: function (n) {
            var t = n.name;
            return t.substr(t.lastIndexOf("\\") + 1)
        }
    }, {
        name: "extension", calculate: function (n) {
            return n.itemType === StolenTech.FileUltimate.UploadItemType.File ? StolenTech.Util.Path.getExtension(n.name, !0) : ""
        }
    }, {
        name: "type", sortType: "asLocaleString", calculate: function (n) {
            return n.itemType === StolenTech.FileUltimate.UploadItemType.File ? n.extension ? StolenTech.Util.Language.getEntry("Label.FileType", n.extension.toUpperCase()) : StolenTech.Util.Language.getEntry("Label.File") : StolenTech.Util.Language.getEntry("Label.FolderType")
        }
    }, {name: "fileRef"}, {name: "thumbnails"}]
});
Ext.define("StolenTech.FileUltimate.UploadStore", {
    extend: "Ext.data.Store", constructor: function () {
        this.callParent(arguments);
        this.nameIndexer = {};
        this.pendingIndexer = {};
        this.on({scope: this, add: this.onIndexerAdd, remove: this.onIndexerRemove, update: this.onIndexerUpdate})
    }, onIndexerAdd: function (n, t) {
        for (var i, u, r = 0; r < t.length; r++) i = t[r], u = this.getIndexerKey(i.data.name), this.nameIndexer[u] = i, i.data.status && i.data.status.value === StolenTech.FileUltimate.UploadStatus.Pending && (this.pendingIndexer[i.data.id] = i)
        ...
        var u, f, e;
        if (i === "edit") for (u = 0; u < r.length; u++) switch (r[u]) {
            case"name":
                ...
                break;
            case"status":
                t.data.status && t.data.status.value === StolenTech.FileUltimate.UploadStatus.Pending ? this.pendingIndexer[t.data.id] = t : delete this.pendingIndexer[t.data.id]
        }
...
Ext.define("StolenTech.FileUltimate.FileUploaderViewModel", {
    extend: "Ext.app.ViewModel",
    alias: "viewmodel.fileuploader",
    data: {
        inProgress: !1,
        queueId: "",
        totalCount: 0,
        ...
        fileProgress: 0,
        uploadMethod: null,
        uploadMethodFeatures: null,
        hasAnySelection: !1,
        hasAnyRecords: !1,
        hasAnyPendingRecords: !1
    },
    formulas: {
        currentProcessedSize: function (n) {
            ...
            if (n("currentProcessedSize") === 0) return StolenTech.Util.Language.getEntry("Label.Calculating");
            var e = ((new Date).getTime() - n("startTime")) / 1e3, o = n("totalSize") - n("currentProcessedSize"),
                r = Math.round(o * e / n("currentProcessedSize")), f = parseInt(r / 3600), i = parseInt(r / 60) % 60,
                u = r % 60, t;
            return f > 0 ? (t = StolenTech.Util.Language.getEntry("Label.TimeEstimateHours", f), i > 0 && (t += " " + StolenTech.Util.Language.getEntry("Label.TimeEstimateMinutes", i))) : i > 0 ? (t = StolenTech.Util.Language.getEntry("Label.TimeEstimateMinutes", i), u > 0 && (t += " " + StolenTech.Util.Language.getEntry("Label.TimeEstimateSeconds", u))) : t = StolenTech.Util.Language.getEntry("Label.TimeEstimateSeconds", u), StolenTech.Util.Language.getEntry("Label.TimeEstimate", t)
        }, itemsRemaining: function (n) {
            var t = n("totalCount") - n("processedCount"), i;
            return n("totalSize") === null ? t : (i = n("totalSize") - n("currentProcessedSize"), t + " (" + StolenTech.Util.Culture.formatByteSize(i) + ")")
        }, speed: function (n) {
            var t, i;
            return n("currentProcessedSize") === 0 ? StolenTech.Util.Language.getEntry("Label.Calculating") : (t = ((new Date).getTime() - n("startTime")) / 1e3, t = (t - t % .1).toFixed(1), i = t > 0 ? n("currentProcessedSize") / t : 0, StolenTech.Util.Language.getEntry("Label.SpeedEstimate", StolenTech.Util.Culture.formatByteSize(i)))
        }, progress: function (n) {
        ...
        }, canAddFile: function (n) {
            return n("uploadMethod") !== null && n("uploadMethodFeatures") !== null && n("uploadMethodFeatures").selectFile
        }, canAddFolder: function (n) {
            return n("uploadMethod") !== null && n("uploadMethodFeatures") !== null && n("uploadMethodFeatures").selectFolder
        }, canStartUpload: function (n) {
            return n("uploadMethod") !== null && n("hasAnyPendingRecords")
        }, infoBarTitle: function (n) {
            return n("inProgress") ? StolenTech.Util.Language.getEntry("Message.UploadInProgress") : StolenTech.Util.Language.getEntry("Message.SelectToUpload")
        }, viewEmptyText: function (n) {
            return n("uploadMethod") !== null && n("uploadMethodFeatures") !== null && n("uploadMethodFeatures").dragAndDrop ? StolenTech.Util.Language.getEntry("Message.DragAndDrop") : ""
        }
    }
});
StolenTech.FileUltimate.UploadItemType = {Folder: 1, File: 2};
StolenTech.FileUltimate.UploadStatus = {
    Pending: 1,
    Rejected: 2,
    Skipped: 3,
    Uploading: 4,
...
StolenTech.FileUltimate.QueueStatus = {
    Starting: 1,
    Started: 2,
    FileStarted: 3,
    FileProcessing: 4,
...
StolenTech.FileUltimate.ValidationAction = {Accept: 0, Reject: 1, ConfirmReplace: 2, Rename: 3};
Ext.define("StolenTech.FileUltimate.UploadHandler", {
    mixins: ["Ext.mixin.Observable"],
    statics: {supportedUploadMethods: [], supportedThumbnailExtensions: []},
    $configPrefixed: !1,
    config: {
        resourceBasePath: "",
        shimContainer: null,
    ...
    onHttpResponse: function (n) {
        return StolenTech.UI.ServerHandler.parseResponse(n)
    },
    onFileEnd: function (n, t) {
        this.fireEvent("fileend", this, n, t)
    }
});
Ext.define("StolenTech.FileUltimate.PlUploadHandler", {
    extend: "StolenTech.FileUltimate.UploadHandler",
    statics: {
    ...
    applyMimeTypes: function (n) {
        ...
        return f ? [{
            title: StolenTech.Util.Language.getEntry("Label.SpecificFiles", o.join(";")),
            extensions: e.join(",")
        }] : []
    },
    updateMimeTypes: function (n) {
        this.uploader && this.uploader.setOption({filters: Ext.apply(this.uploader.getOption("filters"), {mime_types: n})})
    },
    updateChunkSizeInBytes: function (n) {
        this.uploader && this.uploader.setOption({chunk_size: n})
    },
    load: function (n) {
        var t, i;
        if (this.onBeforeLoad(n)) {
            t = {
                ...
                filters: {mime_types: this.mimeTypes, skipMimeTypesCheck: !0, prevent_empty: !1},
                chunk_size: this.chunkSizeInBytes,
                flash_swf_url: StolenTech.Util.Path.combine(this.resourceBasePath, "library/plupload/Moxie.swf"),
                silverlight_xap_url: StolenTech.Util.Path.combine(this.resourceBasePath, "library/plupload/Moxie.xap")
            };
            ...
            switch (n) {
                case"Html4":
                    Ext.apply(t, {runtimes: "html4"});
                    break;
                case"Flash":
                    Ext.apply(t, {runtimes: "flash", multipart: !1});
                    break;
                case"Silverlight":
                    Ext.apply(t, {runtimes: "silverlight", multipart: !1});
                    break;
                case"Html5":
                    Ext.apply(t, {runtimes: "html5", multipart: !1, required_features: "chunks"});
                    break;
                default:
                    this.onLoadError();
                    return
    ...
    getThumbnail: function (n, t, i, r) {
        var o = n.data.fileRef, f = function () {
            this.destroy();
            ...
            this.resize({width: t, height: t, preserveHeaders: !1, fit: !1});
    ...
    cancelFile: function (n) {
        var t = n.data.fileRef, i = t.status === plupload.UPLOADING;
    ...
    onPlUploadInit: function (n, t) {
        if (n !== this.uploader) {
            ...
            var i = {
                ...
                uploadAsBinary: t.runtime.can("send_binary_string"),
                uploadAsForm: t.runtime.can("send_multipart"),
                uploadAsChunks: t.runtime.can("slice_blob"),
    ...
    onPlUploadError: function (n, t) {
        if (t.code === plupload.INIT_ERROR) n.destroy(), this.onLoadError(); else if (t.code === plupload.HTTP_ERROR) {
    ...
    onPlUploadFilesAdded: function (n, t) {
        for (var i, u, f = [], r = 0; r < t.length; r++) i = t[r], u = new StolenTech.FileUltimate.UploadModel({
            id: StolenTech.Util.String.createUniqueId(),
            itemType: StolenTech.FileUltimate.UploadItemType.File,
    ...
    initFolderInput: function () {
        this.folderInput = new moxie.file.FileInput({browse_button: this.selectFolderButton, directory: !0});
        var n = this;
...
Ext.define("StolenTech.FileUltimate.FileDropHelper", {
    singleton: !0, getFilesFromEvent: function (n, t, i) {
        this.fileDrop || (this.fileDrop = new Html5FileDrop);
        this.fileDrop.getFromEvent(n, function (n) {
            if (n.length) t(n); else {
                var r = Ext.browser.name + " " + Ext.browser.version.major,
                    u = StolenTech.Util.Language.getEntry("Message.DropNotRecognized", r);
                i(u)
            }
        })
    }
});
Ext.define("StolenTech.UI.ProgressWithStatus", {
    extend: "Ext.Progress", xtype: ["progresswithstatus", "progresswithstatuswidget"], updateValue: function (n) {
        if (this.statusData = Ext.isObject(n) ? n : null, this.statusData && this.statusData.text) {
            if (this.element.addCls("x-progress-with-status"), this.backgroundEl.setStyle({
                ...
                this.backgroundEl.dom.title = StolenTech.Util.Language.getEntry("Label.ViewStatusReason")
            } else this.backgroundEl.un("click", this.onStatusClick, this), this.backgroundEl.dom.title = "";
            this.hasStatusText = !0;
            this.statusData.details ? this.setText(this.statusData.text + " (?)") : this.setText(this.statusData.text)
...
StolenTech.FileUltimate.FileTypeInfo.baseFileIcons = {
    "file": {
...
StolenTech.FileUltimate.FileTypeInfo.fileIcons = {
    "7z": {
    ...
    "stl": {
        "16": "fileicons-creative16 icon-stl",
        "32": "fileicons-creative32 icon-stl",
        "48": "fileicons-creative48 icon-stl",
        "96": "fileicons-creative96-icon-stl",
        "256": "fileicons-creative256-icon-stl"
    },
    "svg": {
...
StolenTech.FileUltimate.FileTypeInfo.fileIconMappings = {
    "tgz": "tar",
    "taz": "tar",
    "tbz": "tar",
    "tbz2": "tar",
...
StolenTech.FileUltimate.FileTypeInfo.thumbnailTypes = {
    "jpg": {"isImage": true},
    "jpeg": {"isImage": true},
    "jpe": {"isImage": true},
    "jif": {"isImage": true},
...
StolenTech.FileUltimate.FileTypeInfo.archiveTypes = {
    "zip": {"isReadWrite": true},
    "7z": {"isReadOnly": true},
    "rar": {"isReadOnly": true},
    "tar": {"isReadOnly": true},
    "tgz": {"isReadOnly": true},
    "taz": {"isReadOnly": true},
    "tbz": {"isReadOnly": true},
    "tbz2": {"isReadOnly": true},
    "tz2": {"isReadOnly": true},
    "tlz": {"isReadOnly": true},
    "txz": {"isReadOnly": true},
    "gz": {"isReadOnly": true},
    "gzip": {"isReadOnly": true},
    "bz2": {"isReadOnly": true},
    "bzip2": {"isReadOnly": true},
    "lz": {"isReadOnly": true},
    "lzip": {"isReadOnly": true},
    "xz": {"isReadOnly": true}
};
StolenTech.FileUltimate.FileTypeInfo.imageViewerTypes = {
    "jpg": {},
    "jpeg": {},
    "jpe": {},
    "jif": {},
...
StolenTech.FileUltimate.FileTypeInfo.documentViewerTypes = {
    "pdf": {},
    "xps": {},
    "oxps": {},
    "xpz": {},
